...
function endPlayerTimer() {
  ...
  _0x27f8a9.timeOut = true, _0x27f8a9.timeRemaining = 0, speak("Temps écoulé pour " + _0x27f8a9.name + " !"), updatePlayerTimerDisplay();
  let _0x410f6b = players.every(_0x19f52e => _0x19f52e.timeOut);
  ...
  _0x4ad5f8.actions.push({type: "move", from: {x: _0x4ad5f8.x, y: _0x4ad5f8.y}, to: {x: _0x115bd7, y: _0x181620}, distance: _0x38ea01, bites: _0x18142f}), _0x4ad5f8.x = _0x115bd7, _0x4ad5f8.y = _0x181620;
    ...
    if (campOwner !== null && campOwner === _0x4ad5f8.id) {
      ...
      if (oldFatigue > 0 || oldWound > 0) {
        ...
        speak("Repos et soin sur le camp ! Toutes vos fatigues et blessures sont retirÃ©es.");
        addVotes(_0x4ad5f8, 20, "Repos au camp");
        publishGlobalEvent("camp_heal", _0x4ad5f8.name + " s'est reposÃ© au camp ! 🏕️");
      }
    }
...
function encodeCoordinates(_0x385df9, _0x17ef14, _0x11f664) {
  ...
  let _0x2386f3 = Math.floor(Math.random() * 5), _0x18a2d1 = _0x3b7a25[_0x2386f3][_0x17ef14], _0x2e4e2f = alphabet[_0x11f664 - 1];
...
function checkMove3WithoutBite3Times(_0x3e7de9) {
  ...
  let _0x13e683 = _0x3e7de9.actions.filter(_0x22f340 => _0x22f340.type === "move" && _0x22f340.distance === 3);
