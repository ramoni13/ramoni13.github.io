const a0_0x477e5c = a0_0x5756;
(function (_0x37afcd, _0x18512d) {
  const _0x21b21c = a0_0x5756, _0x5f1bd9 = _0x37afcd();
  while (true) {
    try {
      const _0x4d17e9 = parseInt(_0x21b21c(878)) / 1 + -parseInt(_0x21b21c(848)) / 2 * (-parseInt(_0x21b21c(730)) / 3) + parseInt(_0x21b21c(671)) / 4 + parseInt(_0x21b21c(614)) / 5 * (parseInt(_0x21b21c(645)) / 6) + -parseInt(_0x21b21c(804)) / 7 * (parseInt(_0x21b21c(536)) / 8) + parseInt(_0x21b21c(627)) / 9 + -parseInt(_0x21b21c(507)) / 10 * (parseInt(_0x21b21c(851)) / 11);
      if (_0x4d17e9 === _0x18512d) break; else _0x5f1bd9.push(_0x5f1bd9.shift());
    } catch (_0x378704) {
      _0x5f1bd9.push(_0x5f1bd9.shift());
    }
  }
}(a0_0x28d1, 994811));
const synth = window[a0_0x477e5c(535)];
function speak(_0x245816) {
  const _0x32ca72 = a0_0x477e5c;
  synth[_0x32ca72(501)](), setTimeout(() => {
    const _0x283f45 = _0x32ca72, _0x32d877 = new SpeechSynthesisUtterance(_0x245816);
    _0x32d877[_0x283f45(526)] = 1.1, _0x32d877[_0x283f45(911)] = 1, _0x32d877.lang = "fr-CA", synth.speak(_0x32d877);
  }, 250);
}
const alphabet = "ABCDEFGHIJKL";
let players = [
  {id: 2, name: "BLEU", picto: "👤", x: 1, y: 1, votes: 0, leftHand: null, rightHand: null, backpack: [null, null, null], actions: [], status: [], fatigueCards: 0, woundCards: 0, timeRemaining: 600, timeOut: false, turnStartBites: 0, lastActionClicks: [], xp: 0},
  {id: 0, name: "ROUGE", picto: "👨‍🦰", x: 16, y: 1, votes: 0, leftHand: null, rightHand: null, backpack: [null, null, null], actions: [], status: [], fatigueCards: 0, woundCards: 0, timeRemaining: 600, timeOut: false, turnStartBites: 0, lastActionClicks: [], xp: 0},
  {id: 3, name: "JAUNE", picto: "👩", x: 1, y: 12, votes: 0, leftHand: null, rightHand: null, backpack: [null, null, null], actions: [], status: [], fatigueCards: 0, woundCards: 0, timeRemaining: 600, timeOut: false, turnStartBites: 0, lastActionClicks: [], xp: 0},
  {id: 1, name: "VERT", picto: "👨", x: 16, y: 12, votes: 0, leftHand: null, rightHand: null, backpack: [null, null, null], actions: [], status: [], fatigueCards: 0, woundCards: 0, timeRemaining: 600, timeOut: false, turnStartBites: 0, lastActionClicks: [], xp: 0}], currentPlayer = 0, turnStep = 0, currentRange = 0, crocos = [], fishes = [], birds = [], scenery = [], isAnimating = false, currentWeather = a0_0x477e5c(497), selectedItem = null, currentCellItems = [], autoSearchDone = false, giftMode = false, giftTargetPlayer = null, huntMode = false, huntTargets = [], html5QrCode = null, isScanning = false, firebaseDB = null, gameSessionId = null, isOnline = false, mangues = [], totemScanMode = false, totemSelectedItem = null, diamonds = [], hadTotemBeforeSearch = false, gameTimeDuration = 10, gameTimerInterval = null, turnStartTime = null, gameEnded = false, publicHelpSelectedItem = null, selectedPlayers = [], currentPlayerSetupIndex = 0, playerQrCodeScanner = null, isPlayerScanning = false, pendingPlayerId = null, turnSummary = {fatigueAdded: 0, fatigueRemoved: 0, woundAdded: 0, woundRemoved: 0, itemsBroken: [], itemsUsed: [], itemsCollected: [], itemsDropped: [], missionsCompleted: [], votesGained: 0};
const carteBLEU = [{1: "O", 2: "W", 3: "N", 4: "R", 5: "Q", 6: "C", 7: "A", 8: "G", 9: "V", 10: "L", 11: "Z", 12: "U", 13: "E", 14: "Y", 15: "K", 16: "M"}, {1: "Y", 2: "P", 3: "F", 4: "J", 5: "Z", 6: "A", 7: "C", 8: "W", 9: "B", 10: "U", 11: "R", 12: "S", 13: "L", 14: "E", 15: "Q", 16: "D"}, {1: "Z", 2: "V", 3: "M", 4: "G", 5: "T", 6: "S", 7: "I", 8: "E", 9: "R", 10: "K", 11: "H", 12: "D", 13: "N", 14: "B", 15: "F", 16: "C"}, {1: "Y", 2: "C", 3: "H", 4: "J", 5: "A", 6: "X", 7: "D", 8: "L", 9: "S", 10: "I", 11: "B", 12: "V", 13: "K", 14: "Z", 15: "U", 16: "M"}, {1: "I", 2: "B", 3: "Y", 4: "D", 5: "U", 6: "G", 7: "M", 8: "P", 9: "O", 10: "N", 11: "S", 12: "A", 13: "C", 14: "V", 15: "L", 16: "H"}], carteROUGE = [{1: "T", 2: "H", 3: "G", 4: "B", 5: "O", 6: "A", 7: "Z", 8: "P", 9: "X", 10: "R", 11: "U", 12: "S", 13: "Y", 14: "Q", 15: "K", 16: "J"}, {1: "Q", 2: "U", 3: "L", 4: "B", 5: "W", 6: "N", 7: "J", 8: "Z", 9: "X", 10: "H", 11: "E", 12: "R", 13: "D", 14: "G", 15: "F", 16: "C"}, {1: "U", 2: "T", 3: "K", 4: "E", 5: "G", 6: "H", 7: "A", 8: "Q", 9: "C", 10: "M", 11: "B", 12: "O", 13: "Y", 14: "N", 15: "P", 16: "I"}, {1: "E", 2: "K", 3: "V", 4: "B", 5: "I", 6: "D", 7: "Y", 8: "C", 9: "S", 10: "U", 11: "G", 12: "R", 13: "F", 14: "J", 15: "Q", 16: "M"}, {1: "S", 2: "U", 3: "C", 4: "R", 5: "G", 6: "T", 7: "F", 8: "E", 9: "B", 10: "Q", 11: "Z", 12: "K", 13: "I", 14: "P", 15: "D", 16: "Y"}], carteJAUNE = [{1: "K", 2: "Q", 3: "V", 4: "B", 5: "F", 6: "C", 7: "R", 8: "Z", 9: "D", 10: "I", 11: "P", 12: "G", 13: "N", 14: "L", 15: "Y", 16: "E"}, {1: "U", 2: "R", 3: "E", 4: "I", 5: "P", 6: "J", 7: "O", 8: "C", 9: "V", 10: "F", 11: "B", 12: "G", 13: "Y", 14: "L", 15: "Q", 16: "K"}, {1: "G", 2: "F", 3: "C", 4: "Z", 5: "R", 6: "K", 7: "O", 8: "X", 9: "L", 10: "H", 11: "W", 12: "A", 13: "I", 14: "P", 15: "N", 16: "T"}, {1: "B", 2: "J", 3: "M", 4: "G", 5: "O", 6: "Q", 7: "P", 8: "L", 9: "T", 10: "Y", 11: "X", 12: "F", 13: "D", 14: "H", 15: "S", 16: "W"}, {1: "W", 2: "K", 3: "Q", 4: "Z", 5: "J", 6: "I", 7: "R", 8: "O", 9: "V", 10: "L", 11: "E", 12: "T", 13: "A", 14: "C", 15: "D", 16: "Y"}], carteVERT = [{1: "M", 2: "C", 3: "D", 4: "X", 5: "S", 6: "A", 7: "I", 8: "F", 9: "G", 10: "W", 11: "T", 12: "H", 13: "V", 14: "B", 15: "U", 16: "K"}, {1: "D", 2: "E", 3: "V", 4: "R", 5: "G", 6: "J", 7: "A", 8: "Z", 9: "O", 10: "C", 11: "H", 12: "I", 13: "T", 14: "U", 15: "B", 16: "F"}, {1: "N", 2: "D", 3: "K", 4: "E", 5: "S", 6: "O", 7: "C", 8: "I", 9: "H", 10: "F", 11: "M", 12: "L", 13: "P", 14: "X", 15: "Y", 16: "T"}, {1: "Y", 2: "E", 3: "U", 4: "H", 5: "W", 6: "M", 7: "N", 8: "O", 9: "B", 10: "V", 11: "Q", 12: "K", 13: "L", 14: "S", 15: "A", 16: "F"}, {1: "F", 2: "R", 3: "Y", 4: "J", 5: "Z", 6: "V", 7: "G", 8: "U", 9: "I", 10: "D", 11: "L", 12: "N", 13: "X", 14: "A", 15: "H", 16: "M"}], ITEMS = [{name: "totem", icon: "🗿", durability: null}, {name: a0_0x477e5c(828), icon: "⛏️", durability: 3}, {name: "arc", icon: "🏹", durability: 2}, {name: "torche", icon: "🔥", durability: 3}, {name: a0_0x477e5c(628), icon: "🥤", durability: 2}, {name: a0_0x477e5c(608), icon: "🩹", durability: null}, {name: a0_0x477e5c(594), icon: "🎣", durability: 2}, {name: a0_0x477e5c(892), icon: "🥾", durability: 2}];
let hiddenItems = [];
const SECRET_MISSIONS = [{id: 1, description: a0_0x477e5c(897), votes: 120, condition: _0x48c6b9 => checkFruitsCollected(_0x48c6b9, 3)}, {id: 2, description: a0_0x477e5c(466), votes: 180, condition: _0x4fa21c => checkMove3WithoutBite3Times(_0x4fa21c)}, {id: 3, description: a0_0x477e5c(722), votes: 100, condition: _0xc58791 => checkGiftGiven(_0xc58791)}, {id: 4, description: "Chasser ou pêcher 2 animaux", votes: 140, condition: _0x2814c7 => checkHunt2Animals(_0x2814c7)}, {id: 5, description: a0_0x477e5c(713), votes: 160, condition: _0x334bc3 => checkTotemFound(_0x334bc3)}, {id: 6, description: a0_0x477e5c(558), votes: 200, condition: _0x4339d5 => checkSurvive3Bites(_0x4339d5)}, {id: 7, description: a0_0x477e5c(771), votes: 120, condition: _0x338e23 => checkTwoTorches(_0x338e23)}, {id: 8, description: a0_0x477e5c(923), votes: 140, condition: _0x7157e4 => check3ConsecutiveHideClicks(_0x7157e4)}, {id: 9, description: "Collecter 5 objets différents", votes: 160, condition: _0x4a1e0b => checkCollect5Items(_0x4a1e0b)}, {id: 10, description: a0_0x477e5c(587), votes: 180, condition: _0x18402d => checkReachEnemyCamp(_0x18402d)}, ...Array[a0_0x477e5c(491)]({length: 90}, (_0x54d2bd, _0x3c8dd6) => ({id: _0x3c8dd6 + 11, description: "Mission secrète " + (_0x3c8dd6 + 11), votes: 15 + Math[a0_0x477e5c(472)](Math[a0_0x477e5c(480)]() * 35), condition: _0x2136e1 => false}))];
function createItem(_0x8e87e8) {
  const _0x54066e = a0_0x477e5c;
  return {name: _0x8e87e8[_0x54066e(666)], icon: _0x8e87e8.icon, durability: _0x8e87e8[_0x54066e(633)], maxDurability: _0x8e87e8[_0x54066e(633)]};
}
function getBaseOwner(_0x591a98, _0x173af0) {
  if (_0x591a98 <= 2 && _0x173af0 <= 2) return 0;
  if (_0x591a98 >= 15 && _0x173af0 <= 2) return 1;
  if (_0x591a98 <= 2 && _0x173af0 >= 11) return 2;
  if (_0x591a98 >= 15 && _0x173af0 >= 11) return 3;
  return null;
}
function initIsland() {
  const _0x39e299 = a0_0x477e5c;
  let _0x4b4d3d = 1;
  const _0x294a3f = [{x1: 1, x2: 3, y1: 1, y2: 3}, {x1: 14, x2: 16, y1: 1, y2: 3}, {x1: 1, x2: 3, y1: 10, y2: 12}, {x1: 14, x2: 16, y1: 10, y2: 12}];
  _0x294a3f[_0x39e299(849)](_0x1f5ac7 => {
    const _0x26385f = _0x39e299;
    let _0x1805f9 = false, _0x4d7bfa = 0;
    while (!_0x1805f9 && _0x4d7bfa < 100) {
      let _0x216b6c = Math[_0x26385f(472)](Math.random() * (_0x1f5ac7.x2 - _0x1f5ac7.x1 + 1)) + _0x1f5ac7.x1, _0x4178cb = Math[_0x26385f(472)](Math[_0x26385f(480)]() * (_0x1f5ac7.y2 - _0x1f5ac7.y1 + 1)) + _0x1f5ac7.y1;
      getBaseOwner(_0x216b6c, _0x4178cb) === null && (crocos[_0x26385f(948)]({id: _0x4b4d3d++, x: _0x216b6c, y: _0x4178cb, oldX: _0x216b6c, oldY: _0x4178cb, stage: "none", seen: false}), _0x1805f9 = true), _0x4d7bfa++;
    }
  });
  const _0x4c7d65 = [[4, 8, 4, 6], [9, 13, 4, 6], [4, 8, 7, 9], [9, 13, 7, 9]];
  _0x4c7d65[_0x39e299(849)](_0x19aeb6 => {
    const _0x24908c = _0x39e299;
    for (let _0x10705d = 0; _0x10705d < 2; _0x10705d++) {
      let _0x3bfbe6, _0x1e2599, _0x10bd58 = 0;
      do {
        _0x3bfbe6 = Math[_0x24908c(472)](Math[_0x24908c(480)]() * (_0x19aeb6[1] - _0x19aeb6[0] + 1)) + _0x19aeb6[0], _0x1e2599 = Math.floor(Math[_0x24908c(480)]() * (_0x19aeb6[3] - _0x19aeb6[2] + 1)) + _0x19aeb6[2], _0x10bd58++;
      } while ((crocos.some(_0x4a38bc => _0x4a38bc.x === _0x3bfbe6 && _0x4a38bc.y === _0x1e2599) || _0x3bfbe6 >= 7 && _0x3bfbe6 <= 10 && _0x1e2599 >= 5 && _0x1e2599 <= 8) && _0x10bd58 < 100);
      !(_0x3bfbe6 >= 7 && _0x3bfbe6 <= 10 && _0x1e2599 >= 5 && _0x1e2599 <= 8) && crocos[_0x24908c(948)]({id: _0x4b4d3d++, x: _0x3bfbe6, y: _0x1e2599, oldX: _0x3bfbe6, oldY: _0x1e2599, stage: _0x24908c(854), seen: false});
    }
  });
 ...
 scenery.push({x: 16, y: 4, type: 'bananier', icon: '🌿', stock: 1, fruit: '🍌', item: null});
  ...
  _0xe61a94[_0x39e299(849)]((_0x4c0c2c, _0xe8b186) => {
    ITEMS.forEach(_0x1833e6 => {
      const _0x4e6d7e = a0_0x5756;
  ...
  for (let _0x43aebb = 0; _0x43aebb <= 17; _0x43aebb++) {
    for (let _0x44200a = 0; _0x44200a <= 13; _0x44200a++) {
      (_0x43aebb === 0 || _0x43aebb === 17 || _0x44200a === 0 || _0x44200a === 13) && _0x3a7aad[_0x39e299(948)]({x: _0x43aebb, y: _0x44200a});
    }
  }
  for (let _0x284afe = 0; _0x284afe < 10; _0x284afe++) {
    let _0x20edc1 = _0x3a7aad[_0x39e299(540)](_0x267026 => {
      const _0x1cede3 = _0x39e299;
    ...
    if (_0x20edc1[_0x39e299(450)] > 0) {
      let _0x1e6c40 = _0x20edc1[Math[_0x39e299(472)](Math.random() * _0x20edc1[_0x39e299(450)])];
  ...
  for (let _0x9fff1c = 0; _0x9fff1c <= 17; _0x9fff1c++) {
    for (let _0x2e72c3 = 0; _0x2e72c3 <= 13; _0x2e72c3++) {
      _0xcad3e0[_0x39e299(948)]({x: _0x9fff1c, y: _0x2e72c3});
    }
  }
  for (let _0x596a41 = 0; _0x596a41 < 10; _0x596a41++) {
    let _0xdaba9d = _0xcad3e0[_0x39e299(540)](_0x2c625a => {
      const _0x1e5a22 = _0x39e299;
    ...
    if (_0xdaba9d[_0x39e299(450)] > 0) {
      let _0x23efac = _0xdaba9d[Math[_0x39e299(472)](Math[_0x39e299(480)]() * _0xdaba9d[_0x39e299(450)])];
  ...
  for (let _0x46ebf1 = 1; _0x46ebf1 <= 16; _0x46ebf1++) {
    for (let _0x27b04f = 1; _0x27b04f <= 12; _0x27b04f++) {
      ...
      _0x2e6ff4 && !_0x224931 && _0x7ffc58[_0x39e299(948)]({x: _0x46ebf1, y: _0x27b04f});
    }
  }
  for (let _0x309f08 = 0; _0x309f08 < 15; _0x309f08++) {
    let _0x2985f1 = _0x7ffc58[_0x39e299(540)](_0x3ee242 => {
      const _0x4b76a0 = _0x39e299;
    ...
    if (_0x2985f1[_0x39e299(450)] > 0) {
      let _0x5c95ef = _0x2985f1[Math[_0x39e299(472)](Math[_0x39e299(480)]() * _0x2985f1[_0x39e299(450)])];
      mangues[_0x39e299(948)]({x: _0x5c95ef.x, y: _0x5c95ef.y, found: false});
    }
  }
  let _0x37cf51 = [];
  for (let _0x4e41b3 = 7; _0x4e41b3 <= 10; _0x4e41b3++) {
    for (let _0xe770ce = 5; _0xe770ce <= 8; _0xe770ce++) {
      _0x37cf51[_0x39e299(948)]({x: _0x4e41b3, y: _0xe770ce});
    }
  }
  for (let _0x1a4779 = 0; _0x1a4779 < 4; _0x1a4779++) {
    if (_0x37cf51.length === 0) break;
    let _0x483c67 = Math[_0x39e299(472)](Math.random() * _0x37cf51[_0x39e299(450)]), _0x247d05 = _0x37cf51[_0x483c67];
    diamonds[_0x39e299(948)]({x: _0x247d05.x, y: _0x247d05.y, found: false}), _0x37cf51[_0x39e299(827)](_0x483c67, 1);
  }
  console[_0x39e299(670)](_0x39e299(695), crocos), console[_0x39e299(670)](_0x39e299(707), fishes), console.log(_0x39e299(907), birds), console[_0x39e299(670)](_0x39e299(890), mangues), console.log("INIT - Diamants (zone volcan):", diamonds), console.log(_0x39e299(903), hiddenItems.length, "objets répartis"), console[_0x39e299(670)]("INIT - Tous les objets cachés :", hiddenItems), console[_0x39e299(670)](_0x39e299(799), ITEMS[_0x39e299(825)](_0x4b627e => _0x4b627e[_0x39e299(666)] + ": " + hiddenItems[_0x39e299(540)](_0xd3b48d => _0xd3b48d[_0x39e299(530)].name === _0x4b627e[_0x39e299(666)])[_0x39e299(450)]).join(", "));
  let _0x112e1d = hiddenItems[_0x39e299(540)](_0x1112e4 => _0x1112e4[_0x39e299(530)].name === _0x39e299(727));
  console.log(_0x39e299(578)), _0x112e1d[_0x39e299(849)]((_0x58097d, _0x26a938) => {
    const _0x135bcf = _0x39e299;
...
const LAUNCH_PHRASES = ["Direct en cours ! Bienvenue sur Lilocroco TV ! C'est parti pour une nouvelle aventure !", "Mesdames et messieurs, le show commence ! Que le meilleur aventurier gagne !", "Attention, caméras en place ! L'île vous attend, aventuriers !", "3, 2, 1... Action ! Bienvenue dans la plus grande aventure de votre vie !", a0_0x477e5c(482), a0_0x477e5c(820), a0_0x477e5c(492), "Bienvenue dans l'aventure ultime ! Que la chasse aux votes commence !", "Le show le plus attendu de l'année démarre maintenant ! Bonne chance à tous !", a0_0x477e5c(494)];
function showPlayerSelection() {
  const _0x43e836 = a0_0x477e5c;
  let _0x1e7f75 = document[_0x43e836(880)](_0x43e836(845));
  _0x1e7f75 && (gameTimeDuration = parseInt(_0x1e7f75[_0x43e836(956)])), document.getElementById(_0x43e836(750)).style[_0x43e836(699)] = "none", document[_0x43e836(743)](_0x43e836(607)).style[_0x43e836(699)] = _0x43e836(574), initFirebase(), updatePlayerSelectionUI();
}
function updatePlayerSelectionUI() {
  const _0x41b1fa = a0_0x477e5c, _0x30e291 = ["ROUGE", "VERT", "BLEU", "JAUNE"], _0x25522e = ['player-color-2', 'player-color-0', 'player-color-3', 'player-color-1'], _0x5421de = ["👨‍🦰","👨","👤", "👩"];
...
function confirmPlayerName() {
  ...
  let _0x30783e = {name: _0x6336af, votes: 0, leftHand: null, rightHand: null, backpack: [null, null, null], actions: [], status: [], fatigueCards: 0, woundCards: 0, timeRemaining: gameTimeDuration * 60, timeOut: false, turnStartBites: 0, lastActionClicks: [], xp: 0};
...
function createPlayerFromData(_0x3a631c, _0x547da1) {
  const _0x117827 = a0_0x477e5c, _0x447ed3 = ["👨‍🦰","👨","👤", "👩" ], _0x22c13a = [{x: 1, y: 1}, {x: 16, y: 1}, {x: 1, y: 12}, {x: 16, y: 12}];
...
function launchGame() {
  const _0x3d966c = a0_0x477e5c;
  players[_0x3d966c(849)](_0xd1d12f => {
    const _0x432495 = _0x3d966c;
    !_0xd1d12f[_0x432495(764)] && (_0xd1d12f[_0x432495(764)] = gameTimeDuration * 60), _0xd1d12f[_0x432495(819)] = false;
  }), initIsland(), startPlayerTimer();
...
function initFirebase() {
  const _0x397045 = a0_0x477e5c, _0x59e75c = {apiKey: _0x397045(622), authDomain: _0x397045(557), databaseURL: _0x397045(893), projectId: _0x397045(465), storageBucket: _0x397045(829), messagingSenderId: _0x397045(910), appId: _0x397045(748), measurementId: "G-9L8FBHX54F"};
  try {
...
function showSyncIndicator() {
  const _0x2698df = a0_0x477e5c, _0x4762a2 = document[_0x2698df(743)](_0x2698df(858));
...
function displayGlobalEvents(_0x791d4c) {
  const _0x2514ac = a0_0x477e5c, _0x34aa61 = document.getElementById("global-events"), _0x20e7ea = document[_0x2514ac(743)](_0x2514ac(780));
...
function getTimeAgo(_0x26a39a) {
  const _0x4c05d4 = a0_0x477e5c, _0x448583 = Math[_0x4c05d4(472)]((Date[_0x4c05d4(770)]() - _0x26a39a) / 1e3);
...
function renderGrid() {
  const _0x552af2 = a0_0x477e5c, _0x435e8e = document.getElementById(_0x552af2(686));
...
function startTurn() {
  const _0x4141ca = a0_0x477e5c, _0x231cb0 = players[currentPlayer];
  ...
  if (crocos.some(_0xae19d => _0xae19d.x === _0x231cb0.x && _0xae19d.y === _0x231cb0.y)) {
    if (_0x4cddb2) speak(_0x4141ca(794)); else _0xf64b18 ? speak(_0x4141ca(545)) : (_0x231cb0[_0x4141ca(826)]++, turnSummary[_0x4141ca(562)]++, _0x231cb0.turnStartBites = 1, updateFatigueWoundDisplay(_0x231cb0), checkEvacuation(_0x231cb0), document[_0x4141ca(743)](_0x4141ca(696))[_0x4141ca(880)]("p")[_0x4141ca(443)] = _0x4141ca(440), document[_0x4141ca(743)](_0x4141ca(642))[_0x4141ca(612)][_0x4141ca(699)] = _0x4141ca(887), document.getElementById(_0x4141ca(696)).style.display = _0x4141ca(887), speak(_0x4141ca(785)));
  }
...
function executeMove(_0x115bd7, _0x181620, _0x38ea01) {
  ...
  if (_0x4ad5f8.x === _0x115bd7 && _0x4ad5f8.y === _0x181620) {
    if (crocos.some(_0x36b3f5 => _0x36b3f5.x === _0x4ad5f8.x && _0x36b3f5.y === _0x4ad5f8.y)) {
      ...
      if (!_0x34da5b) {
        _0x4ad5f8.woundCards++, turnSummary[_0x1316e9(562)]++, updateFatigueWoundDisplay(_0x4ad5f8), checkEvacuation(_0x4ad5f8);
    ...
    _0x4ad5f8.actions.push({type: _0x1316e9(560), from: {x: _0x4ad5f8.x, y: _0x4ad5f8.y}, to: {x: _0x115bd7, y: _0x181620}, distance: 0, bites: 0}), turnStep = 2, document[_0x1316e9(743)](_0x1316e9(550))[_0x1316e9(612)][_0x1316e9(699)] = "none", document[_0x1316e9(743)](_0x1316e9(446))[_0x1316e9(612)][_0x1316e9(699)] = _0x1316e9(686), updateQRButtonVisibility(), renderGrid();
    return;
  }
  ...
  if (_0x1a6adf > 0) {
    ...
    if (_0x1a6adf === 2) speak("   Double Fatigue. Ajoutez 2 cartes Fatigue.");
  }
  if (_0x18142f > 0) {
    ...
    if (_0x58eb33) speak(_0x1316e9(792)), _0x4ad5f8.actions.push({type: "torch_protection"}), checkSecretMission(_0x4ad5f8); else {
      _0x4ad5f8.woundCards += _0x18142f, turnSummary[_0x1316e9(562)] += _0x18142f, updateFatigueWoundDisplay(_0x4ad5f8), checkEvacuation(_0x4ad5f8);
      let _0x152252 = _0x18142f === 1 ? _0x1316e9(506) : _0x18142f + _0x1316e9(836), _0x21478f = _0x18142f === 1 ? "1 carte blessure" : _0x18142f + " cartes blessure";
  ...
  turnStep = 2, document[_0x1316e9(743)](_0x1316e9(550))[_0x1316e9(612)][_0x1316e9(699)] = _0x1316e9(854), document[_0x1316e9(743)]("menu-actions")[_0x1316e9(612)][_0x1316e9(699)] = _0x1316e9(686), updateQRButtonVisibility();
  ...
  _0x3ca60d ? (autoSearchDone = true, speak(_0x1316e9(581)), performAutoSearch()) : autoSearchDone = false, document.getElementById(_0x1316e9(575)).disabled = autoSearchDone, updateGiftButton(), updateHuntButton(), updatePublicHelpButton(), renderGrid();
}
function performAutoSearch() {
  const _0x15194f = a0_0x477e5c;
  ...
  let _0x18a658 = hiddenItems[_0x15194f(540)](_0x18278b => _0x18278b.x === _0x8b6270.x && _0x18278b.y === _0x8b6270.y && !_0x18278b.found);
...
function doAction(_0x138461) {
  ...
  if (_0x138461 === "fouille") {
    ...
    _0x3662cf[_0x8b79c9(849)](_0x248812 => {
      ...
      currentCellItems[_0x335c00(948)]({type: _0x335c00(530), icon: _0x248812[_0x335c00(530)][_0x335c00(937)], name: _0x248812[_0x335c00(530)][_0x335c00(666)], durability: _0x248812.item[_0x335c00(633)], maxDurability: _0x248812[_0x335c00(530)][_0x335c00(591)]}), _0x248812[_0x335c00(865)] = true, !_0x248812[_0x335c00(700)] && (_0x248812[_0x335c00(700)] = true), console[_0x335c00(670)]("Objet trouvé en (" + _0x30a212.x + ", " + _0x30a212.y + "): " + _0x248812.item[_0x335c00(666)]);
    });
    ...
    if (_0x138461 === _0x8b79c9(899)) _0x30a212[_0x8b79c9(638)][_0x8b79c9(948)](_0x8b79c9(474)), _0x30a212[_0x8b79c9(490)].push({type: "cache", location: {x: _0x30a212.x, y: _0x30a212.y}}), checkSecretMission(_0x30a212), speak(_0x8b79c9(537)), endTurnLog(), showTurnSummary(); else {
      if (_0x138461 === "repos") showRestMenu(); else {
        if (_0x138461 === _0x8b79c9(947)) giftMode = true, speak(_0x8b79c9(615)), renderGrid(); else {
          if (_0x138461 === "chasse") huntMode = true, huntTargets = getAdjacentHuntTargets(), speak(_0x8b79c9(886)), renderGrid(); else {
            ...
            } else endTurnLog(), showTurnSummary();
          }
        }
      }
    }
...
function closePublicHelpResult() {
  const _0x224855 = a0_0x477e5c;
  document[_0x224855(743)](_0x224855(690)).style[_0x224855(699)] = "none", document[_0x224855(743)](_0x224855(642))[_0x224855(612)][_0x224855(699)] = "none", document[_0x224855(743)]("totem-scan-btn").innerText = _0x224855(916), document.getElementById(_0x224855(672)).onclick = activateTotemScan, document[_0x224855(743)](_0x224855(527))[_0x224855(880)]("h3")[_0x224855(443)] = _0x224855(821), document.getElementById(_0x224855(527))[_0x224855(880)]("p")[_0x224855(443)] = _0x224855(779), publicHelpSelectedItem = null, endTurnLog(), showTurnSummary();
}
function showLootInventory() {
  const _0x9e4a5 = a0_0x477e5c;
...
function showTurnSummary() {
  ...
  let _0x45a441 = Math[_0x23d181(472)](_0x1a8853[_0x23d181(764)] / 60), _0x22da20 = _0x1a8853.timeRemaining % 60;
  document[_0x23d181(743)](_0x23d181(835))[_0x23d181(443)] = _0x45a441 + ":" + _0x22da20[_0x23d181(952)]()[_0x23d181(876)](2, "0");
...
function proceedCloseLoot() {
  ...
  hadTotemBeforeSearch = false, endTurnLog(), showTurnSummary();
}
function showTotemScanner() {
  const _0x2dd22a = a0_0x477e5c;
...
function closeTotemScan() {
  const _0xadff05 = a0_0x477e5c;
  totemScanMode = false, totemSelectedItem = null, document.getElementById(_0xadff05(624))[_0xadff05(483)][_0xadff05(478)](_0xadff05(555)), endTurnLog(), showTurnSummary();
}
function confirmTurn() {
  const _0x4a7a69 = a0_0x477e5c;
...
function updateWeather() {
  const _0x174722 = a0_0x477e5c, _0x8545ef = [_0x174722(685), _0x174722(958), "Pluie fine", "Beau temps"];
...
function updateUI() {
  ...
  _0x19c5c9[_0x184ecf(620)] && !_0x19c5c9[_0x184ecf(620)].completed && (_0xc1ae9c += _0x184ecf(588) + _0x19c5c9.secretMission.id + "</span>"), document[_0x184ecf(743)](_0x184ecf(702))[_0x184ecf(617)] = _0xc1ae9c, document.getElementById(_0x184ecf(891))[_0x184ecf(443)] = _0x19c5c9[_0x184ecf(644)], updateFatigueWoundDisplay(_0x19c5c9), document.getElementById(_0x184ecf(838))[_0x184ecf(504)] = _0x19c5c9[_0x184ecf(675)] === 0, document[_0x184ecf(743)](_0x184ecf(571))[_0x184ecf(504)] = _0x19c5c9.woundCards === 0, updateQRButtonVisibility(), checkSecretMission(_0x19c5c9), checkEvacuation(_0x19c5c9);
}
function updateFatigueWoundDisplay(_0x526fa5) {
  const _0x2c7165 = a0_0x477e5c, _0x5935eb = document.getElementById(_0x2c7165(725)), _0x202964 = document[_0x2c7165(743)](_0x2c7165(783));
...
function closeEvacuationPopup(_0x41c3a1) {
  ...
  _0x13ab23[_0x2ae395(880)]("h3")[_0x2ae395(443)] = "MORSURE !", _0x13ab23.querySelector("h3").style[_0x2ae395(471)] = _0x2ae395(701), _0x13ab23.querySelector(_0x2ae395(511)).innerText = "🐊", _0x13ab23[_0x2ae395(880)]("p")[_0x2ae395(443)] = "Morsure : ajoutez une carte blessure à votre défausse.", respawnPlayerItems(_0x41c3a1);
  ...
  _0x41c3a1.x = _0x507517[_0x41c3a1.id].x, _0x41c3a1.y = _0x507517[_0x41c3a1.id].y, _0x5cf922 > 0 ? speak(_0x2ae395(812) + _0x5cf922 + _0x2ae395(867)) : speak(_0x2ae395(521)), endTurnLog(), showTurnSummary();
}
function respawnPlayerItems(_0x4008) {
  const _0x35f894 = a0_0x477e5c;
  let _0x1c1396 = [];
...
function huntTarget(_0x459668) {
  ...
  _0x2b667d.actions[_0x1b304b(948)]({type: "chasse", target: _0x459668[_0x1b304b(561)], location: {x: _0x2b667d.x, y: _0x2b667d.y}}), checkSecretMission(_0x2b667d), huntMode = false, huntTargets = [], endTurnLog(), showTurnSummary();
}
function respawnFish(_0x55e675) {
  const _0x173197 = a0_0x477e5c;
  let _0x21595c = [];
...
function isConsumable(_0xd2c8fe) {
  const _0x203afd = a0_0x477e5c;
  return _0xd2c8fe[_0x203afd(666)] === "trousse" || _0xd2c8fe[_0x203afd(561)] === _0x203afd(766);
}
function getConsumableEffect(_0x3220ea) {
  const _0x40ec6d = a0_0x477e5c;
  if (_0x3220ea[_0x40ec6d(666)] === _0x40ec6d(608)) return {name: _0x40ec6d(570), message: _0x40ec6d(436), fatigue: -1, wound: -2}; else {
    if (_0x3220ea[_0x40ec6d(937)] === "🥥") return {name: "Noix de coco", message: "Vous récupérez fatigue et immunité. Retirez 1 fatigue et 1 blessure.", fatigue: -1, wound: -1}; else {
      if (_0x3220ea[_0x40ec6d(937)] === "🍌") return {name: "Banane", message: _0x40ec6d(802), fatigue: -2, wound: 0}; else {
        if (_0x3220ea[_0x40ec6d(937)] === "🥭") return {name: "Mangue", message: "Un petit coup de boost. Défaussez 2 fatigues.", fatigue: -2, wound: 0};
      }
    }
  }
  return null;
...
function doRest() {
  ...
  _0x597075[_0x399b49(490)][_0x399b49(948)]({type: _0x399b49(605), location: {x: _0x597075.x, y: _0x597075.y}, inCamp: _0x3805a6}), checkSecretMission(_0x597075), closeRest(), endTurnLog(), showTurnSummary();
}
function consumeItem(_0x4627e1, _0x446a69) {
  const _0xdd5e02 = a0_0x477e5c;
  ...
  _0x1b6a77[_0xdd5e02(490)][_0xdd5e02(948)]({type: _0xdd5e02(657), item: _0x446a69[_0xdd5e02(666)], location: {x: _0x1b6a77.x, y: _0x1b6a77.y}}), closeRest(), endTurnLog(), showTurnSummary();
}
function closeRest() {
  const _0x4e2834 = a0_0x477e5c;
...
function checkSurvive3Bites(_0x439149) {
  const _0x443000 = a0_0x477e5c;
  return _0x439149[_0x443000(826)] >= 3;
}
function checkTwoTorches(_0xca8fc3) {
  const _0x1f3068 = a0_0x477e5c;
