...
function toggleMute() {
  ...
  if (isMuted) {
    ...
    muteBtn.title = 'Voix désactivée - Cliquer pour activer';
    if (window.speechSynthesis) window.speechSynthesis.cancel();
  } else {
    muteBtn.textContent = '🔊';
    muteBtn.classList.remove('muted');
    muteBtn.title = 'Voix activée - Cliquer pour désactiver';
  }
}
...
function showToast(message, type, icon) {
  ...
  const iconHTML = icon ? "<span style=\"font-size:1.5rem;\">" + icon + "</span>" : "";
...
function updateHeaderWeather() {
  ...
  // Retirer toutes les classes mÃ©tÃ©o
  header.classList.remove("weather-sunny", "weather-canicule", "weather-orage", "weather-pluie");
  
  // Ajouter la classe correspondant Ã  la mÃ©tÃ©o actuelle
  if (currentWeather === "Canicule") {
    header.classList.add("weather-canicule");
  } else if (currentWeather === "Orage") {
    header.classList.add("weather-orage");
  } else if (currentWeather === "Pluie fine") {
    header.classList.add("weather-pluie");
  } else {
    // Beau temps par dÃ©faut
...
function initIsland() {
    ...
    ITEMS.forEach(_0x1833e6 => {
      ...
      for (let _0xff5bc1 = 0; _0xff5bc1 < 2; _0xff5bc1++) {
        ...
        while (!_0x220e21 && _0x2d27a2 < 100) {
          let _0x1e2294 = Math.floor(Math.random() * (_0x4c0c2c.x2 - _0x4c0c2c.x1 + 1)) + _0x4c0c2c.x1, _0x47983c = Math.floor(Math.random() * (_0x4c0c2c.y2 - _0x4c0c2c.y1 + 1)) + _0x4c0c2c.y1;
          getBaseOwner(_0x1e2294, _0x47983c) === null && !(_0x1e2294 === 0 || _0x1e2294 === 17 || _0x47983c === 0 || _0x47983c === 13) && !(_0x1e2294 >= 7 && _0x1e2294 <= 10 && _0x47983c >= 5 && _0x47983c <= 8) && (hiddenItems.push({x: _0x1e2294, y: _0x47983c, item: createItem(_0x1833e6), found: false, discovered: false, zone: _0xe8b186}), _0x220e21 = true), _0x2d27a2++;
        }
      }
    });
  });
  ...
  for (let _0x284afe = 0; _0x284afe < 10; _0x284afe++) {
    let _0x20edc1 = _0x3a7aad.filter(_0x267026 => {
  ...
  for (let _0x596a41 = 0; _0x596a41 < 10; _0x596a41++) {
    let _0xdaba9d = _0xcad3e0.filter(_0x2c625a => {
    ...
    if (_0xdaba9d.length > 0) {
      let _0x23efac = _0xdaba9d[Math.floor(Math.random() * _0xdaba9d.length)];
  ...
  for (let _0x309f08 = 0; _0x309f08 < 15; _0x309f08++) {
    let _0x2985f1 = _0x7ffc58.filter(_0x3ee242 => {
    ...
    if (_0x2985f1.length > 0) {
      let _0x5c95ef = _0x2985f1[Math.floor(Math.random() * _0x2985f1.length)];
  ...
  for (let _0x1a4779 = 0; _0x1a4779 < 4; _0x1a4779++) {
    ...
    let _0x483c67 = Math.floor(Math.random() * _0x37cf51.length), _0x247d05 = _0x37cf51[_0x483c67];
    diamonds.push({x: _0x247d05.x, y: _0x247d05.y, found: false}), _0x37cf51.splice(_0x483c67, 1);
  }
  console.log("INIT - Crocos:", crocos), console.log("INIT - Poissons:", fishes), console.log("INIT - Oiseaux:", birds), console.log("INIT - Mangues (cachées):", mangues), console.log("INIT - Diamants (zone volcan):", diamonds), console.log("INIT - Objets cachés:", hiddenItems.length, "objets répartis"), console.log("INIT - Tous les objets cachés :", hiddenItems), console.log("INIT - Détail objets:", ITEMS.map(_0x4b627e => _0x4b627e.name + ": " + hiddenItems.filter(_0xd3b48d => _0xd3b48d.item.name === _0x4b627e.name).length).join(", "));
  let _0x112e1d = hiddenItems.filter(_0x1112e4 => _0x1112e4.item.name === "totem");
  console.log("INIT - Emplacements des TOTEMS 🗿:"), _0x112e1d.forEach((_0x58097d, _0x26a938) => {
    const _0x135bcf = decoder;
    let _0x2061a5 = "" + alphabet[_0x58097d.y] + _0x58097d.x;
...
const LAUNCH_PHRASES = ["Direct en cours ! Bienvenue sur Lilocroco TV ! C'est parti pour une nouvelle aventure !", "Mesdames et messieurs, le show commence ! Que le meilleur aventurier gagne !", "Attention, caméras en place ! L'île vous attend, aventuriers !", "3, 2, 1... Action ! Bienvenue dans la plus grande aventure de votre vie !", "Le direct démarre ! Crocodiles, épreuves et votes vous attendent sur l'île !", "Chers téléspectateurs, installez-vous ! Le spectacle va commencer !", "Lilocroco TV est en direct ! Qui survivra aux dangers de l'île mystérieuse ?", "Bienvenue dans l'aventure ultime ! Que la chasse aux votes commence !", "Le show le plus attendu de l'année démarre maintenant ! Bonne chance à tous !", "Attention, nous sommes en direct ! L'île, les crocos et la gloire vous attendent !"];
function showPlayerSelection() {
  const _0x43e836 = getString;
  let _0x1e7f75 = document.querySelector("input[name=\"gameDuration\"]:checked");
  _0x1e7f75 && (globalGameDuration = parseInt(_0x1e7f75.value)), 
  document.getElementById("start-overlay").style.display = "none", 
  document.getElementById("player-selection-overlay").style.display = "flex", 
  initFirebase(), 
...
function scanPersonalPlayer() {
  ...
  document.getElementById("player-qr-scanner-modal").style.display = "block", document.getElementById("player-qr-status").innerText = "Positionnez le QR Code devant la caméra", playerQrCodeScanner = new Html5Qrcode("player-qr-reader");
  const _0x2af837 = {fps: 10, qrbox: {width: 250, height: 250}, aspectRatio: 1};
  playerQrCodeScanner.start({facingMode: "environment"}, _0x2af837, onPlayerQRCodeScanned, onPlayerQRCodeError).then(() => {
    isPlayerScanning = true;
  }).catch(_0x12ecfe => {
    const _0xb90a43 = _0x12defe;
    console.error("Erreur démarrage caméra:", _0x12ecfe), document.getElementById("player-qr-status").innerText = "Erreur: Impossible d'accéder à la caméra";
  });
}
function onPlayerQRCodeScanned(_0x2096ab, _0x5606ec) {
  ...
  if (!_0x2096ab.startsWith("lilo") || !_0x2096ab.endsWith("croco")) {
    document.getElementById("player-qr-status").innerText = "QR Code invalide ! (doit commencer par \"lilo\" et finir par \"croco\")", speak("QR Code invalide !");
    return;
  }
  let _0x2f439b = _0x2096ab.substring(4, _0x2096ab.length - 5);
  if (!_0x2f439b || _0x2f439b.length === 0) {
    document.getElementById("player-qr-status").innerText = "QR Code invalide ! (identifiant vide)", speak("QR Code invalide !");
    return;
  }
  console.log("Identifiant unique extrait:", _0x2f439b), closePlayerQRScanner(), checkPlayerProfile(_0x2f439b);
}
function onPlayerQRCodeError(_0x880095) {}
function closePlayerQRScanner() {
  const _0x3b1927 = getString;
  playerQrCodeScanner && isPlayerScanning ? playerQrCodeScanner.stop().then(() => {
    const _0x346621 = _0x3b1927;
    isPlayerScanning = false, playerQrCodeScanner.clear(), document.getElementById("player-qr-scanner-modal").style.display = "none";
  }).catch(_0x278093 => {
    const _0x508834 = _0x3b1927;
    console.error("Erreur arrêt caméra:", _0x278093);
  }) : document.getElementById("player-qr-scanner-modal").style.display = "none";
}
function checkPlayerProfile(_0x59a650) {
  const _0x4d1f46 = getString;
  if (!firebaseDB) {
    console.warn("Firebase non disponible, création profil local"), pendingPlayerId = _0x59a650, showNameInputPopup();
    return;
  }
  const _0x871f9b = firebaseDB.ref("players/" + _0x59a650), _0x1980ba = new Promise((_0x277eb9, _0x6750cd) => setTimeout(() => _0x6750cd(new Error("Timeout")), 5e3));
  Promise.race([_0x871f9b.once("value"), _0x1980ba]).then(_0x3490b1 => {
    const _0x8ff6d6 = _0x4d1f46;
    if (_0x3490b1.exists()) {
      let _0x334d68 = _0x3490b1.val();
      console.log("Profil existant récupéré:", _0x334d68), createPlayerFromData(_0x59a650, _0x334d68), speak("Bienvenue " + _0x334d68.name + " !");
    } else console.log("Nouveau profil, demande du nom"), pendingPlayerId = _0x59a650, showNameInputPopup();
  }).catch(_0x264303 => {
    const _0x33f771 = _0x4d1f46;
    console.error("Erreur Firebase:", _0x264303), console.log("Création profil local (mode hors ligne)"), pendingPlayerId = _0x59a650, showNameInputPopup();
  });
}
function showNameInputPopup() {
  const _0x2e92de = getString;
  document.getElementById("player-name-input").value = "", document.getElementById("name-input-box").style.display = "block", document.getElementById("overlay").style.display = "block";
}
function confirmPlayerName() {
  const _0x5db061 = getString;
  let _0x6336af = document.getElementById("player-name-input").value.trim();
  if (!_0x6336af || _0x6336af.length === 0) {
    speak("Veuillez entrer un nom");
    return;
  }
  document.getElementById("name-input-box").style.display = "none", document.getElementById("overlay").style.display = "none";
  ...
  firebaseDB && firebaseDB.ref("players/" + pendingPlayerId).set(_0x30783e).then(() => {
    const _0x6ca844 = _0x5db061;
    console.log("Profil créé dans Firebase:", pendingPlayerId, _0x30783e), speak("Profil créé pour " + _0x6336af + " !");
  }).catch(_0x3d2625 => {
    const _0x3323a8 = _0x5db061;
    console.error("Erreur création profil:", _0x3d2625);
...
function askForNextPlayer() {
  ...
  document.getElementById("add-player-box").style.display = "block", document.getElementById("overlay").style.display = "block";
}
function addAnotherPlayer() {
  const _0x3119f9 = getString;
  document.getElementById("add-player-box").style.display = "none", currentPlayerSetupIndex++, updatePlayerSelectionUI();
}
function startGameWithPlayers() {
  const _0x384f9f = getString;
  document.getElementById("add-player-box").style.display = "none", document.getElementById("player-selection-overlay").style.display = "none", document.getElementById("overlay").style.display = "none", players = selectedPlayers, console.log("Joueurs finaux:", players), launchGame();
}
function launchGame() {
...
function startPlayerTimer() {
  ...
  turnStartTime = Date.now(), updatePlayerTimerDisplay(), gameTimerInterval && clearInterval(gameTimerInterval), gameTimerInterval = setInterval(() => {
    ...
    _0x37d1c0.timeRemaining = Math.max(0, _0x37d1c0.timeRemaining - 1), updatePlayerTimerDisplay(), _0x37d1c0.timeRemaining <= 0 && endPlayerTimer();
  }, 1e3);
  */
}
function updatePlayerTimerDisplay() {
  const _0x22d61a = getString;
  //let _0x2dd688 = players[currentPlayer], _0x578d58 = Math.floor(_0x2dd688.timeRemaining / 60), _0xd29de8 = _0x2dd688.timeRemaining % 60, _0x13b8d5 = _0x578d58 + ":" + _0xd29de8.toString().padStart(2, "0"), _0xf7b8a0 = "", _0x269220 = "";
...
function showSyncIndicator() {
  ...
  _0x4762a2[_0x2698df(483)][_0x2698df(568)]("active"), setTimeout(() => {
    ...
    _0x4762a2.classList.remove("active");
  }, 3e3);
}
function listenToGlobalWeather() {
  const _0x455e23 = getString;
  if (!firebaseDB) return;
  const _0x2bb2a6 = firebaseDB.ref("global/weather");
  _0x2bb2a6.on("value", _0x44d1cd => {
...
function listenToGlobalEvents() {
  ...
  if (!firebaseDB) return;
  const _0x542c8a = firebaseDB.ref("global/events").limitToLast(10);
  _0x542c8a.on("value", _0x28ad9a => {
    const _0x5f4e1f = _0x4544ce, _0x49f864 = [];
    _0x28ad9a[_0x5f4e1f(849)](_0x243539 => {
      const _0x5c7306 = _0x5f4e1f;
      _0x49f864.push(_0x243539.val());
...
function publishGlobalEvent(_0x2d49ee, _0x138db5) {
  ...
  }).catch(_0x1ba7c5 => console.error("Erreur publication:", _0x1ba7c5));
}
function publishGlobalWeather(_0x1344a5) {
  const _0x34e5a4 = getString;
  if (!firebaseDB || !isOnline) return;
  const _0x5cb1c4 = {weather: _0x1344a5, timestamp: Date.now(), sessionId: gameSessionId};
  firebaseDB.ref("global/weather").set(_0x5cb1c4).then(() => {
    const _0x411a85 = _0x34e5a4;
    console.log("Météo publiée:", _0x1344a5), showSyncIndicator();
  }).catch(_0x555c52 => console.error("Erreur publication météo:", _0x555c52));
}
function hasBottes(_0x34fb6a) {
  const _0x2083fa = getString;
  return _0x34fb6a.leftHand && _0x34fb6a.leftHand.name === "bottes" || _0x34fb6a.rightHand && _0x34fb6a.rightHand.name === "bottes" || _0x34fb6a.backpack.some(_0x184be9 => _0x184be9 && _0x184be9.name === "bottes");
}
function prepMove(_0x4c4199) {
  const _0x4e47d7 = getString;
  if (isAnimating) return;
  let _0x3e3bd6 = players[currentPlayer];
  if (currentWeather === "Orage" && !hasBottes(_0x3e3bd6)) _0x4c4199--;
...
function getDistance(_0x42ddf8, _0x55fb26, _0x3caa46, _0x292c9f) {
  ...
  return Math.abs(_0x42ddf8 - _0x3caa46) + Math.abs(_0x55fb26 - _0x292c9f);
}
function hasGourde(_0x95cb36) {
  const _0x3ec5e9 = getString;
  return _0x95cb36.leftHand && _0x95cb36.leftHand.name === "gourde" || _0x95cb36.rightHand && _0x95cb36.rightHand.name === "gourde" || _0x95cb36.backpack.some(_0x57f64e => _0x57f64e && _0x57f64e.name === "gourde");
}
function renderGrid() {
    ...
    for (let _0x5be19c = _0x9a978.x - 3; _0x5be19c <= _0x9a978.x + 3; _0x5be19c++) {
      ...
      if (_0x5be19c < 0 || _0x5be19c > 17 || _0x50b533 < 0 || _0x50b533 > 13) _0x192798.className = _0x552af2(721); else {
        if (_0x5be19c === 0 || _0x5be19c === 17 || _0x50b533 === 0 || _0x50b533 === 13) _0x192798[_0x552af2(901)] = "cell cell-sea", huntMode && turnStep === 2 && huntTargets[_0x552af2(849)](_0x3a5885 => {
          ...
          _0x3a5885.x === _0x5be19c && _0x3a5885.y === _0x50b533 && (_0x192798.classList.add("cell-huntable"), _0x192798.onclick = () => huntTarget(_0x3a5885));
        }), crocos[_0x552af2(849)](_0x5a381a => {
          const _0x464b8a = _0x552af2;
          if (_0x5a381a.x === _0x5be19c && _0x5a381a.y === _0x50b533) {
            let _0x403451 = document.createElement("div");
            _0x403451.className = "croco-unit", _0x403451.innerHTML = '🐊<div class="croco-num">' + _0x5a381a.id + "</div>", _0x192798.appendChild(_0x403451);
          }
        }), fishes[_0x552af2(849)](_0x164a73 => {
          const _0x1af9ef = _0x552af2;
          if (_0x164a73.x === _0x5be19c && _0x164a73.y === _0x50b533) {
            let _0x25cbe8 = document.createElement("div");
            _0x25cbe8.className = "fish-unit", _0x25cbe8.innerHTML = '🐟<div class="fish-num">' + _0x164a73.id + "</div>", _0x192798.appendChild(_0x25cbe8);
          }
        }), birds[_0x552af2(849)](_0x3444c9 => {
          const _0x3c6218 = _0x552af2;
          if (_0x3444c9.x === _0x5be19c && _0x3444c9.y === _0x50b533) {
            let _0x45b635 = document.createElement("div");
            _0x45b635.className = "bird-unit", _0x45b635.innerHTML = '🦅<div class="bird-num">' + _0x3444c9.id + "</div>", _0x192798.appendChild(_0x45b635);
          }
        }); else {
          ...
          if (giftMode && turnStep === 2) {
            ...
            _0x17f28d[_0x552af2(849)](_0x1a4204 => {
              ...
              _0x1a4204.x === _0x5be19c && _0x1a4204.y === _0x50b533 && (_0x192798.classList.add("cell-giftable"), _0x192798.onclick = () => selectGiftTarget(_0x1a4204.id));
            });
          }
          huntMode && turnStep === 2 && huntTargets.forEach(_0xf36964 => {
            const _0x5ef0cf = _0x552af2;
            _0xf36964.x === _0x5be19c && _0xf36964.y === _0x50b533 && (_0x192798.classList.add("cell-huntable"), _0x192798.onclick = () => huntTarget(_0xf36964));
          });
          !totemScanMode && crocos[_0x552af2(849)](_0x58a3c2 => {
            const _0x43584c = _0x552af2;
            if (_0x58a3c2.x === _0x5be19c && _0x58a3c2.y === _0x50b533) {
              let _0x3b670f = document.createElement("div");
              _0x3b670f.className = "croco-unit", _0x3b670f.innerHTML = "🐊<div class=\"croco-num\">" + _0x58a3c2.id + "</div>", _0x192798.appendChild(_0x3b670f);
            }
          });
          players[_0x552af2(849)](_0x2a0dde => {
            const _0x4de3b0 = _0x552af2;
            if (_0x2a0dde.x === _0x5be19c && _0x2a0dde.y === _0x50b533) _0x192798.innerHTML += "<span class=\"pion\">" + _0x2a0dde.picto + "</span>";
          });
          if (totemScanMode && totemSelectedItem) {
            ...
            _0x58b72e[_0x552af2(849)](_0x549a0d => {
              ...
              _0x192798.innerHTML += _0x549a0d.item.icon;
            });
          } else scenery[_0x552af2(849)](_0x3fd19a => {
            const _0x58a3b3 = _0x552af2;
            if (_0x3fd19a.x === _0x5be19c && _0x3fd19a.y === _0x50b533) _0x192798.innerHTML += _0x3fd19a.icon;
          }), birds[_0x552af2(849)](_0x28b29a => {
            const _0x6bd026 = _0x552af2;
            if (_0x28b29a.x === _0x5be19c && _0x28b29a.y === _0x50b533) {
              let _0x3dbfe2 = document.createElement("div");
              _0x3dbfe2.className = "bird-unit", _0x3dbfe2.innerHTML = "🦅<div class=\"bird-num\">" + _0x28b29a.id + "</div>", _0x192798.appendChild(_0x3dbfe2);
            }
          });
          _0x192798.innerHTML += _0x552af2(786) + alphabet[_0x50b533] + _0x5be19c + "</span>";
...
function moveFishesGlobal() {
  ...
  console.log("AVANT DEPLACEMENT - Poissons:", JSON.parse(JSON.stringify(fishes))), fishes.forEach(_0x379167 => {
    const _0x2747d4 = _0x38f3b3;
    let _0x32b5a7 = [{x: 0, y: 1}, {x: 0, y: -1}, {x: 1, y: 0}, {x: -1, y: 0}], _0x1478df = _0x32b5a7.filter(_0x2bf051 => {
      ...
      if (crocos.some(_0x49eeb8 => _0x49eeb8.x === _0x5cd745 && _0x49eeb8.y === _0x35d798)) return false;
      if (fishes.some(_0x5ac66b => _0x5ac66b.id !== _0x379167.id && _0x5ac66b.x === _0x5cd745 && _0x5ac66b.y === _0x35d798)) return false;
    ...
    if (_0x1478df.length > 0) {
      let _0x38b42a = _0x1478df[Math.floor(Math.random() * _0x1478df.length)];
...
function moveBirdsGlobal() {
  ...
  console.log("AVANT DEPLACEMENT - Oiseaux:", JSON.parse(JSON.stringify(birds))), birds.forEach(_0x7e1b4c => {
    let _0x366a7b = [{x: 0, y: 1}, {x: 0, y: -1}, {x: 1, y: 0}, {x: -1, y: 0}], _0x5f4096 = _0x366a7b.filter(_0x2e8224 => {
      ...
      if (crocos.some(_0x214e19 => _0x214e19.x === _0x17983c && _0x214e19.y === _0x56dfea)) return false;
      if (fishes.some(_0x5b218f => _0x5b218f.x === _0x17983c && _0x5b218f.y === _0x56dfea)) return false;
      if (birds.some(_0x30ee51 => _0x30ee51.id !== _0x7e1b4c.id && _0x30ee51.x === _0x17983c && _0x30ee51.y === _0x56dfea)) return false;
...
function countCrocosOnPath(_0xa41be7, _0x2ec6a7, _0x4c00ce, _0x3f7b1e, _0x41bdd5) {
  ...
  _0x2148d3.set(_0xa41be7 + "," + _0x2ec6a7, 0);
  while (_0x4baf3e.length > 0) {
    let _0x205c33 = _0x4baf3e.shift();
    if (_0x205c33.x === _0x4c00ce && _0x205c33.y === _0x3f7b1e) {
      let _0xd04368 = _0x205c33.path.filter(_0x2eb9f5 => crocos.some(_0xc3426c => _0xc3426c.x === _0x2eb9f5.x && _0xc3426c.y === _0x2eb9f5.y)).length;
      _0x251c21.push({path: _0x205c33.path, crocos: _0xd04368, dist: _0x205c33.dist});
      continue;
    }
    if (_0x205c33.dist >= _0x41bdd5) continue;
    ...
    for (let _0x5cdd7f of _0x2da838) {
      ...
      (!_0x2148d3.has(_0x2c5110) || _0x2148d3.get(_0x2c5110) >= _0x1635bb) && (_0x2148d3.set(_0x2c5110, _0x1635bb), _0x4baf3e.push({x: _0x5cdd7f.x, y: _0x5cdd7f.y, dist: _0x1635bb, path: [..._0x205c33.path, {x: _0x5cdd7f.x, y: _0x5cdd7f.y}]}));
    }
  }
  if (_0x251c21.length === 0) return -1;
  return _0x251c21.sort((_0x2964d9, _0x322fb8) => {
    const _0x226334 = _0x48f223;
    if (_0x2964d9.crocos !== _0x322fb8.crocos) return _0x2964d9.crocos - _0x322fb8.crocos;
    return _0x2964d9.dist - _0x322fb8.dist;
  }), _0x251c21[0].crocos;
}
...
function finalizeTurnMove(_0x14fe50, _0x22dc39, _0x5ddbb9) {
  ...
  let _0x21d4ce = "" + alphabet[_0x22dc39] + _0x14fe50;
  document.getElementById("move-confirm-text").innerText = "Vous allez vous déplacer en " + _0x21d4ce, document.getElementById("overlay").style.display = "block", document.getElementById("move-confirm-box").style.display = "block";
}
function cancelMove() {
  const _0x4515c5 = getString;
  document.getElementById("move-confirm-box").style.display = "none", document.getElementById("overlay").style.display = "none", pendingMove = null, renderGrid();
}
function confirmMove() {
  const _0x4a14bc = getString;
  document.getElementById("move-confirm-box").style.display = "none", document.getElementById("overlay").style.display = "none";
...
function executeMove(_0x115bd7, _0x181620, _0x38ea01) {
  ...
  _0x4ad5f8.actions.push({type: "move", from: {x: _0x4ad5f8.x, y: _0x4ad5f8.y}, to: {x: _0x115bd7, y: _0x181620}, distance: _0x38ea01, bites: _0x18142f}), _0x4ad5f8.x = _0x115bd7, _0x4ad5f8.y = _0x181620;
    // VÃ©rification si le joueur arrive sur son propre camp
    let campOwner = getBaseOwner(_0x115bd7, _0x181620);
    if (campOwner !== null && campOwner === _0x4ad5f8.id) {
      let oldFatigue = _0x4ad5f8.fatigueCards;
      let oldWound = _0x4ad5f8.woundCards;
      if (oldFatigue > 0 || oldWound > 0) {
        _0x4ad5f8.fatigueCards = 0;
        _0x4ad5f8.woundCards = 0;
        turnSummary.fatigueRemoved += oldFatigue;
        turnSummary.woundRemoved += oldWound;
        updateFatigueWoundDisplay(_0x4ad5f8);
        showToast("Repos et soin sur le camp !", "success", "🏕️");
        speak("Repos et soin sur le camp ! Toutes vos fatigues et blessures sont retirées.");
        addVotes(_0x4ad5f8, 20, "Repos au camp");
        publishGlobalEvent("camp_heal", _0x4ad5f8.name + " s'est reposé au camp ! 🏕️");
      }
    }
  if (_0x115bd7 >= 7 && _0x115bd7 <= 10 && _0x181620 >= 5 && _0x181620 <= 8 && _0x38ea01 > 0) {
    _0x4ad5f8.woundCards++, turnSummary.woundAdded++, updateFatigueWoundDisplay(_0x4ad5f8), checkEvacuation(_0x4ad5f8), showToast("Zone Volcan ! +1 Blessure", "danger", "🌋");
  }
  _0x38ea01 === 3 && (addVotes(_0x4ad5f8, 20, "Déplacement de 3 cases !"), publishGlobalEvent("move3", "a fait un déplacement de 3 cases ! 🏃"));
  checkSecretMission(_0x4ad5f8);
  let _0x1a6adf = 0, _0x36285e = hasGourde(_0x4ad5f8);
  if (currentWeather === "Canicule" && !_0x36285e) {
  ...
  if (_0x1a6adf > 0) {
    _0x4ad5f8.fatigueCards += _0x1a6adf, turnSummary.fatigueAdded += _0x1a6adf, updateFatigueWoundDisplay(_0x4ad5f8), checkEvacuation(_0x4ad5f8);
    if (_0x1a6adf === 1) speak("   Fatigue. +1 Fatigue.");
    if (_0x1a6adf === 2) speak("   Double Fatigue. +2 Fatigues.");
  }
  if (_0x18142f > 0) {
    let _0x58eb33 = _0x4ad5f8.leftHand && _0x4ad5f8.leftHand.name === "torche" || _0x4ad5f8.rightHand && _0x4ad5f8.rightHand.name === "torche";
    if (_0x58eb33) speak("Votre torche vous protège des crocodiles sur le chemin !"), _0x4ad5f8.actions.push({type: "torch_protection"}), checkSecretMission(_0x4ad5f8); else {
      _0x4ad5f8.woundCards += _0x18142f, _0x4ad5f8.turnStartBites += _0x18142f, turnSummary.woundAdded += _0x18142f, updateFatigueWoundDisplay(_0x4ad5f8), checkEvacuation(_0x4ad5f8);
      let _0x152252 = _0x18142f === 1 ? "1 morsure" : _0x18142f + " morsures", _0x21478f = _0x18142f === 1 ? "+1 Blessure" : _0x18142f + " Blessures";
      document.getElementById("bite-box").querySelector("p").innerText = _0x152252 + " : ajoutez " + _0x21478f + " à votre défausse.", showToast(_0x152252 + " : " + _0x21478f, "danger", "🐊"), speak(_0x152252 + " Ajoutez " + _0x21478f + "."), addVotes(_0x4ad5f8, 50, "Morsure pendant le déplacement !"), publishGlobalEvent("bite", "a survécu à " + _0x18142f + " morsure" + (_0x18142f > 1 ? "s" : "") + " ! 🐊");
    }
  }
  turnStep = 2, 
  //document.getElementById("deck-menu").style.display = "none", 
  document.getElementById("menu-actions").style.display = "grid", 
  updateQRButtonVisibility();
  let _0x3ca60d = _0x4ad5f8.leftHand && _0x4ad5f8.leftHand.name === "pioche" || _0x4ad5f8.rightHand && _0x4ad5f8.rightHand.name === "pioche";
  if (_0x3ca60d) {
    autoSearchDone = true;
...
function performAutoSearch() {
  ...
  hadTotemBeforeSearch = _0x8b6270.leftHand && _0x8b6270.leftHand.name === "totem" || _0x8b6270.rightHand && _0x8b6270.rightHand.name === "totem" || _0x8b6270.backpack.some(_0xa8fe4b => _0xa8fe4b && _0xa8fe4b.name === "totem"), currentCellItems = [];
  let _0xb93578 = scenery.filter(_0x3f18aa => _0x3f18aa.x === _0x8b6270.x && _0x3f18aa.y === _0x8b6270.y);
  _0xb93578.forEach(_0x215f6e => {
    const _0x115f25 = _0x15194f;
    _0x215f6e.stock > 0 && (currentCellItems.push({type: "fruit", icon: _0x215f6e.fruit, name: _0x215f6e.type}), _0x215f6e.stock--), _0x215f6e.item && (currentCellItems.push({type: "item", icon: _0x215f6e.item.icon, name: _0x215f6e.item.name, durability: _0x215f6e.item.durability, maxDurability: _0x215f6e.item.maxDurability}), _0x215f6e.item = null);
  });
  let _0x18a658 = hiddenItems.filter(_0x18278b => _0x18278b.x === _0x8b6270.x && _0x18278b.y === _0x8b6270.y && !_0x18278b.found);
  // FIX: Vérifier le totem AVANT de marquer discovered (fouille auto)
  let _0x587c7b_auto = _0x18a658.find(_0x2a9c85 => _0x2a9c85.item.name === "totem");
  _0x587c7b_auto && !_0x587c7b_auto.discovered && (_0x587c7b_auto.discovered = true, addVotes(_0x8b6270, 50, "Découverte d'un totem !"), publishGlobalEvent("totem", "a trouvé un totem ! 🗿"));
  _0x18a658.forEach(_0x94f051 => {
    const _0x5ea2d2 = _0x15194f;
    currentCellItems.push({type: "item", icon: _0x94f051.item.icon, name: _0x94f051.item.name, durability: _0x94f051.item.durability, maxDurability: _0x94f051.item.maxDurability}), _0x94f051.found = true, console.log("Objet trouvé en (" + _0x8b6270.x + ", " + _0x8b6270.y + "): " + _0x94f051.item.name);
  });
  let _0x2a5023 = mangues.findIndex(_0x2a3dbb => _0x2a3dbb.x === _0x8b6270.x && _0x2a3dbb.y === _0x8b6270.y && !_0x2a3dbb.found);
  _0x2a5023 !== -1 && (currentCellItems.push({type: "fruit", icon: "🥭", name: "mangue"}), mangues[_0x2a5023].found = true, console.log("Mangue trouvée en (" + _0x8b6270.x + ", " + _0x8b6270.y + ") !"));
  let _0xafca = diamonds.findIndex(_0x4b8757 => _0x4b8757.x === _0x8b6270.x && _0x4b8757.y === _0x8b6270.y && !_0x4b8757.found), _0x2e1de0 = false;
  _0xafca !== -1 && (diamonds[_0xafca].found = true, _0x2e1de0 = true, console.log("Diamant trouvé en (" + _0x8b6270.x + ", " + _0x8b6270.y + ") !"));
  _0x8b6270.actions.push({type: "fouille_auto", items: currentCellItems, location: {x: _0x8b6270.x, y: _0x8b6270.y}}), checkSecretMission(_0x8b6270);
  if (_0x2e1de0) {
    handleDiamondFound(_0x8b6270);
    return;
  }
  (currentCellItems.length > 0 || autoSearchDone) && showLootInventory();
}
function doAction(_0x138461) {
  ...
  if (_0x138461 === "fouille") {
    ...
    hadTotemBeforeSearch = _0x30a212.leftHand && _0x30a212.leftHand.name === "totem" || _0x30a212.rightHand && _0x30a212.rightHand.name === "totem" || _0x30a212.backpack.some(_0x2dbd84 => _0x2dbd84 && _0x2dbd84.name === "totem"), currentCellItems = [];
    let _0x152809 = scenery.filter(_0x201a14 => _0x201a14.x === _0x30a212.x && _0x201a14.y === _0x30a212.y);
    _0x152809.forEach(_0x4fad5f => {
      const _0x2eed40 = _0x8b79c9;
      _0x4fad5f.stock > 0 && (currentCellItems.push({type: "fruit", icon: _0x4fad5f.fruit, name: _0x4fad5f.type}), _0x4fad5f.stock--), _0x4fad5f.item && (currentCellItems.push({type: "item", icon: _0x4fad5f.item.icon, name: _0x4fad5f.item.name, durability: _0x4fad5f.item.durability, maxDurability: _0x4fad5f.item.maxDurability}), _0x4fad5f.item = null);
    });
    let _0x3662cf = hiddenItems.filter(_0x4a1858 => _0x4a1858.x === _0x30a212.x && _0x4a1858.y === _0x30a212.y && !_0x4a1858.found);
    // FIX: Vérifier le totem AVANT de marquer discovered pour donner les 50 votes
    let _0x587c7b = _0x3662cf.find(_0x2a9c85 => _0x2a9c85.item.name === "totem");
    _0x587c7b && !_0x587c7b.discovered && (_0x587c7b.discovered = true, addVotes(_0x30a212, 50, "Découverte d'un totem !"), publishGlobalEvent("totem", "a trouvé un totem ! 🗿"));
    // Marquer tous les objets comme discovered
    _0x3662cf.forEach(_0x248812 => {
      const _0x335c00 = _0x8b79c9;
      currentCellItems.push({type: "item", icon: _0x248812.item.icon, name: _0x248812.item.name, durability: _0x248812.item.durability, maxDurability: _0x248812.item.maxDurability}), _0x248812.found = true, console.log("Objet trouvé en (" + _0x30a212.x + ", " + _0x30a212.y + "): " + _0x248812.item.name);
    });
    let _0x5dd82c = mangues.findIndex(_0x5ce386 => _0x5ce386.x === _0x30a212.x && _0x5ce386.y === _0x30a212.y && !_0x5ce386.found);
    _0x5dd82c !== -1 && (currentCellItems.push({type: "fruit", icon: "🥭", name: "mangue"}), mangues[_0x5dd82c].found = true, console.log("Mangue trouvée en (" + _0x30a212.x + ", " + _0x30a212.y + ") !"));
    let _0x467aef = diamonds.findIndex(_0x5506a3 => _0x5506a3.x === _0x30a212.x && _0x5506a3.y === _0x30a212.y && !_0x5506a3.found), _0x4bd455 = false;
    _0x467aef !== -1 && (diamonds[_0x467aef].found = true, _0x4bd455 = true, console.log("Diamant trouvé en (" + _0x30a212.x + ", " + _0x30a212.y + ") !"));
    _0x30a212.actions.push({type: "fouille", items: currentCellItems, location: {x: _0x30a212.x, y: _0x30a212.y}});
    let _0x1685d5 = _0x152809.length > 0, _0x11e092 = currentCellItems.some(_0x4b44f0 => _0x4b44f0.type === "item");
    !_0x1685d5 && _0x11e092 && addVotes(_0x30a212, 20, "Fouille hors arbres avec découverte !");
    ...
    if (_0x138461 === "cache") _0x30a212.status.push("caché"), _0x30a212.actions.push({type: "cache", location: {x: _0x30a212.x, y: _0x30a212.y}}), checkSecretMission(_0x30a212), speak("Vous vous cachez. Vous êtes protégé des crocodiles au prochain tour."), endTurnLog(), prepareEndTurn(); else {
      if (_0x138461 === "repos") showRestMenu(); else {
        if (_0x138461 === "don") giftMode = true, speak("Sélectionnez un joueur adjacent pour lui donner un objet."), renderGrid(); else {
          if (_0x138461 === "chasse") huntMode = true, huntTargets = getAdjacentHuntTargets(), speak("Sélectionnez votre cible."), renderGrid(); else {
            if (_0x138461 === "aide_public") {
              let _0x2387a4 = players[currentPlayer];
              if (_0x2387a4.votes < 20) {
                speak("Vous n'avez pas assez de votes pour l'aide du public !");
                return;
              }
              document.getElementById("overlay").style.display = "block", document.getElementById("public-help-confirm-box").style.display = "block";
...
function cancelPublicHelp() {
  ...
  document.getElementById("public-help-confirm-box").style.display = "none", document.getElementById("overlay").style.display = "none", publicHelpMode = false;
}
function confirmPublicHelp() {
  const _0x549cda = getString;
  document.getElementById("public-help-confirm-box").style.display = "none";
  let _0x47f91b = document.getElementById("totem-items-grid");
  _0x47f91b.innerHTML = "", ITEMS.forEach(_0x1537f4 => {
    const _0x3d9e4a = _0x549cda;
    if (_0x1537f4.name !== "totem") {
      let _0x298157 = document.createElement("div");
      _0x298157.className = "totem-item-card", _0x298157.innerText = _0x1537f4.icon, _0x298157.onclick = () => selectPublicHelpItem(_0x1537f4.name, _0x1537f4.icon, _0x298157), _0x47f91b.appendChild(_0x298157);
    }
  }), publicHelpSelectedItem = null, document.getElementById("totem-scan-btn").disabled = true, document.getElementById("totem-scan-btn").innerText = "DEMANDER AU PUBLIC", document.getElementById("totem-scan-btn").onclick = activatePublicHelp, document.getElementById("totem-scanner-box").querySelector("h3").innerText = "📢 AIDE DU PUBLIC", document.getElementById("totem-scanner-box").querySelector("p").innerText = "Sélectionnez l'objet à rechercher", document.getElementById("totem-scanner-box").style.display = "block", document.getElementById("overlay").style.display = "block";
}
function selectPublicHelpItem(_0x3247ec, _0x1fd965, _0x562c5a) {
  const _0x9c2447 = getString;
  document.querySelectorAll(".totem-item-card").forEach(_0x3d76ea => _0x3d76ea.classList.remove("selected")), _0x562c5a.classList.add("selected"), publicHelpSelectedItem = {name: _0x3247ec, icon: _0x1fd965}, document.getElementById("totem-scan-btn").disabled = false;
}
function activatePublicHelp() {
  ...
  let _0x3ff1c0 = findClosestItem(_0x5529a0.x, _0x5529a0.y, publicHelpSelectedItem.name);
  if (!_0x3ff1c0) {
    speak("Aucun objet de ce type n'a été trouvé sur l'île."), document.getElementById("overlay").style.display = "none", publicHelpMode = false;
    return;
  }
  _0x5529a0.votes -= 20, turnSummary.votesGained -= 20, updateUI();
  let _0x4cddd4 = encodeCoordinates(_0x5529a0, _0x3ff1c0.x, _0x3ff1c0.y);
  document.getElementById("public-help-item-icon").innerText = publicHelpSelectedItem.icon, document.getElementById("public-help-result-text").innerHTML = "L'objet <strong>" + publicHelpSelectedItem.name + '</strong> le + proche se trouve à :<br><br><strong style="font-size:1.5rem; color:#f39c12;">' + _0x4cddd4 + "</strong>", document.getElementById("public-help-result-box").style.display = "block", speak("Le public vous indique que l'objet " + publicHelpSelectedItem.name + " le plus proche se trouve en " + _0x4cddd4 + "."), _0x5529a0.actions.push({type: "aide_public", item: publicHelpSelectedItem.name, cost: 20, location: {x: _0x5529a0.x, y: _0x5529a0.y}}), publicHelpMode = false;
}
function findClosestItem(_0x189d1c, _0x4f8bfd, _0x3fd8b7) {
  const _0x323225 = getString;
  let _0x343afe = hiddenItems.filter(_0x582369 => !_0x582369.found && _0x582369.item.name === _0x3fd8b7);
  if (_0x343afe.length === 0) return null;
  let _0x9367df = null, _0x4a3d23 = Infinity;
  return _0x343afe.forEach(_0x4af929 => {
...
function encodeCoordinates(_0x385df9, _0x17ef14, _0x11f664) {
  ...
  let _0x2386f3 = Math.floor(Math.random() * 5), _0x18a2d1 = _0x3b7a25[_0x2386f3][_0x17ef14], _0x2e4e2f = alphabet[_0x11f664];
  return "L" + (_0x2386f3 + 1) + " : " + _0x2e4e2f + "-" + _0x18a2d1;
}
function closePublicHelpResult() {
  const _0x224855 = getString;
  document.getElementById("public-help-result-box").style.display = "none", document.getElementById("overlay").style.display = "none", document.getElementById("totem-scan-btn").innerText = "SCANNER LA ZONE", document.getElementById("totem-scan-btn").onclick = activateTotemScan, document.getElementById("totem-scanner-box").querySelector("h3").innerText = "🗿 SCANNER TOTEM", document.getElementById("totem-scanner-box").querySelector("p").innerText = "Sélectionnez l'objet à scanner sur la zone", publicHelpSelectedItem = null, endTurnLog(), prepareEndTurn();
}
function showLootInventory() {
  const _0x9e4a5 = getString;
  let _0x4e8162 = players[currentPlayer];
  selectedItem = null, document.getElementById("inv-left").innerText = _0x4e8162.leftHand ? _0x4e8162.leftHand.icon : "", document.getElementById("inv-right").innerText = _0x4e8162.rightHand ? _0x4e8162.rightHand.icon : "", document.getElementById("inv-back0").innerText = _0x4e8162.backpack[0] ? _0x4e8162.backpack[0].icon : "", document.getElementById("inv-back1").innerText = _0x4e8162.backpack[1] ? _0x4e8162.backpack[1].icon : "", document.getElementById("inv-back2").innerText = _0x4e8162.backpack[2] ? _0x4e8162.backpack[2].icon : "";
  let _0x2bb338 = document.getElementById("items-found");
  _0x2bb338.innerHTML = "", currentCellItems.length === 0 ? _0x2bb338.innerHTML = "<p style=\"color: #999;\">Rien trouvé</p>" : currentCellItems.forEach((_0x47d6d4, _0x3498da) => {
...
function selectFoundItem(_0x293407) {
  ...
  selectedItem = {source: "found", index: _0x293407}, document.querySelectorAll(".item-card").forEach((_0x17d128, _0x5d1477) => {
    const _0xeb1513 = _0x28e00b;
    _0x17d128.classList.toggle("selected", _0x5d1477 === _0x293407);
  }), document.querySelectorAll(".inv-slot").forEach(_0x310f00 => _0x310f00.classList.remove("selected"));
}
function selectInventorySlot(_0x23c59b) {
  ...
  if (!selectedItem) {
    let _0x34851b = null;
    if (_0x23c59b === "left" && _0x11b6ff.leftHand) _0x34851b = _0x11b6ff.leftHand, _0x11b6ff.leftHand = null; else {
      if (_0x23c59b === "right" && _0x11b6ff.rightHand) _0x34851b = _0x11b6ff.rightHand, _0x11b6ff.rightHand = null; else {
        if (_0x23c59b.startsWith("back")) {
          let _0x2f1d0d = parseInt(_0x23c59b.replace("back", ""));
          _0x11b6ff.backpack[_0x2f1d0d] && (_0x34851b = _0x11b6ff.backpack[_0x2f1d0d], _0x11b6ff.backpack[_0x2f1d0d] = null);
        }
      }
    }
    _0x34851b && (currentCellItems.push(_0x34851b), turnSummary.itemsDropped.push({icon: _0x34851b.icon, name: _0x34851b.name || _0x34851b.type}), updateGiftButton(), showLootInventory());
    return;
  }
  let _0x1fcf8e = null;
  selectedItem.source === "found" && (_0x1fcf8e = currentCellItems[selectedItem.index], currentCellItems.splice(selectedItem.index, 1));
  let _0x2179f9 = null;
  if (_0x23c59b === "left") _0x2179f9 = _0x11b6ff.leftHand, _0x11b6ff.leftHand = _0x1fcf8e, console.log("Objet placé dans main gauche:", _0x1fcf8e); else {
    if (_0x23c59b === "right") _0x2179f9 = _0x11b6ff.rightHand, _0x11b6ff.rightHand = _0x1fcf8e, console.log("Objet placé dans main droite:", _0x1fcf8e); else {
      if (_0x23c59b.startsWith("back")) {
        let _0x2474a0 = parseInt(_0x23c59b.replace("back", ""));
        _0x2179f9 = _0x11b6ff.backpack[_0x2474a0], _0x11b6ff.backpack[_0x2474a0] = _0x1fcf8e, console.log("Objet placé dans sac[" + _0x2474a0 + "]:", _0x1fcf8e);
      }
    }
  }
  _0x2179f9 && currentCellItems.push(_0x2179f9), _0x1fcf8e && (turnSummary.itemsCollected.push({icon: _0x1fcf8e.icon, name: _0x1fcf8e.name || _0x1fcf8e.type}), _0x1fcf8e.type === "diamond" && (addVotes(_0x11b6ff, 200, "Découverte d'un diamant !"), setTimeout(() => {
    const _0x257399 = _0x20fa49;
    let _0x39accc = document.getElementById("bite-box");
    _0x39accc.querySelector("h3").innerText = "FÉLICITATIONS !", _0x39accc.querySelector("h3").style.color = "var(--gold)", _0x39accc.querySelector("div").innerText = "💎", _0x39accc.querySelector("p").innerText = "Vous avez trouvé un diamant ! Vous gagnez 200 votes !", document.getElementById("overlay").style.display = "block", _0x39accc.style.display = "block", speak("Félicitations ! Vous avez trouvé un diamant ! 200 votes du public !"), publishGlobalEvent("diamond", "a trouvé un diamant ! 💎 (+200 votes)");
  }, 100))), selectedItem = null, updateGiftButton(), showLootInventory();
}
function endTurnLog() {
  const _0x34b718 = getString;
  console.log("========== FIN TOUR =========="), console.log("TOUS LES JOUEURS:", JSON.parse(JSON.stringify(players)));
}
...
function showTurnSummary() {
  ...
  document.getElementById("summary-total-fatigue").innerText = _0x1a8853.fatigueCards;
  document.getElementById("summary-total-wound").innerText = _0x1a8853.woundCards;
  let _0x3d2834 = "";
  turnSummary.fatigueAdded > 0 && (_0x3d2834 += '<div class="summary-item negative"><span class="summary-icon">😫</span><span>+' + turnSummary.fatigueAdded + " Fatigue</span></div>");
  turnSummary.fatigueRemoved > 0 && (_0x3d2834 += '<div class="summary-item positive"><span class="summary-icon">😊</span><span>-' + turnSummary.fatigueRemoved + " Fatigue</span></div>");
  turnSummary.woundAdded > 0 && (_0x3d2834 += "<div class=\"summary-item negative\"><span class=\"summary-icon\">🩸</span><span>+" + turnSummary.woundAdded + " Blessure</span></div>");
  turnSummary.woundRemoved > 0 && (_0x3d2834 += "<div class=\"summary-item positive\"><span class=\"summary-icon\">💚</span><span>-" + turnSummary.woundRemoved + " Blessure</span></div>");
  if (!_0x3d2834) _0x3d2834 = "<div class=\"summary-empty\">Aucun changement</div>";
  document.getElementById("summary-cards-content").innerHTML = _0x3d2834;
  let _0x4a81d7 = "";
  turnSummary.itemsCollected.forEach(_0x11460b => {
    const _0x4b5aea = _0x23d181;
    _0x4a81d7 += "<div class=\"summary-item positive\"><span class=\"summary-icon\">" + _0x11460b.icon + "</span><span>" + _0x11460b.name + " ramassé(e)</span></div>";
  }), turnSummary.itemsDropped.forEach(_0x2234ad => {
    const _0x4f00fe = _0x23d181;
    _0x4a81d7 += "<div class=\"summary-item neutral\"><span class=\"summary-icon\">" + _0x2234ad.icon + "</span><span>" + _0x2234ad.name + " posé(e)</span></div>";
  }), turnSummary.itemsBroken.forEach(_0x9c68c4 => {
    const _0x5a5f68 = _0x23d181;
    _0x4a81d7 += "<div class=\"summary-item negative\"><span class=\"summary-icon\">" + _0x9c68c4.icon + "</span><span>" + _0x9c68c4.name + " cassé(e)</span></div>";
  }), turnSummary.itemsUsed.forEach(_0x1c875e => {
    const _0x3ca3e1 = _0x23d181;
    _0x4a81d7 += "<div class=\"summary-item neutral\"><span class=\"summary-icon\">" + _0x1c875e.icon + "</span><span>" + _0x1c875e.name + " " + _0x1c875e.action + "</span></div>";
  });
  if (!_0x4a81d7) _0x4a81d7 = '<div class="summary-empty">Aucun changement</div>';
  document.getElementById("summary-items-content").innerHTML = _0x4a81d7;
  let _0x3607bf = "";
  turnSummary.missionsCompleted.forEach(_0x498aae => {
    const _0x4904b0 = _0x23d181;
    _0x3607bf += "<div class=\"summary-item positive\"><span class=\"summary-icon\">🎯</span><span>Mission #" + _0x498aae.id + " accomplie ! (+" + _0x498aae.votes + " votes)</span></div>";
  });
  if (!_0x3607bf) _0x3607bf = "<div class=\"summary-empty\">Aucune mission accomplie</div>";
  document.getElementById("summary-missions-content").innerHTML = _0x3607bf;
  let _0x33a2a3 = "";
  turnSummary.votesGained > 0 ? _0x33a2a3 = '<div class="summary-item positive"><span class="summary-icon">⭐</span><span>+' + turnSummary.votesGained + " votes gagnés</span></div>" : _0x33a2a3 = "<div class=\"summary-empty\">Aucun vote gagné</div>", document.getElementById("summary-votes-content").innerHTML = _0x33a2a3, document.getElementById("overlay").style.display = "block", document.getElementById("turn-summary-box").style.display = "block";
}

function closeTurnSummary() {
  const _0x51aee7 = getString;
  document.getElementById("turn-summary-box").style.display = "none", showPlayerChange();
}
...
function closeLoot() {
  ...
  let _0x177a85 = players[currentPlayer], _0x3ea844 = currentCellItems.length, _0x7499b2 = turnSummary.itemsCollected.length;
  if (_0x3ea844 > 0 && _0x7499b2 === 0) {
    document.getElementById("loot-box").style.display = "none";
    let _0x3d41d0 = document.getElementById("bite-box"), _0x8754b6 = _0x3d41d0.querySelector("h3"), _0x2fdfb1 = _0x3d41d0.querySelector("div"), _0x15ec16 = _0x3d41d0.querySelector("p"), _0x2d77c1 = _0x3d41d0.querySelector("button");
    if (_0x8754b6) _0x8754b6.innerText = "ATTENTION !";
    if (_0x8754b6) _0x8754b6.style.color = "#e67e22";
    if (_0x2fdfb1) _0x2fdfb1.innerText = "⚠️";
    if (_0x15ec16) _0x15ec16.innerText = "Vous n'avez rien pris ! Voulez-vous vraiment terminer la fouille ?";
...
function confirmCloseLoot() {
  ...
  document.getElementById("bite-box").style.display = "none";
  let _0xa2c851 = document.getElementById("bite-box"), _0x3b90ad = _0xa2c851.querySelector('div[style*="display: flex"]');
  _0x3b90ad && (_0x3b90ad.outerHTML = "<button onclick=\"closeBite()\" style=\"background:var(--red); color:white; width:100%; padding:12px; border:none; border-radius:10px;\">OK</button>"), proceedCloseLoot();
}
function proceedCloseLoot() {
  ...
  if (autoSearchDone) {
    ...
    if (_0x343ab8 && !hadTotemBeforeSearch) {
      let _0x81399 = hiddenItems.find(_0x3dd78c => _0x3dd78c.x === _0x2bde4f.x && _0x3dd78c.y === _0x2bde4f.y && _0x3dd78c.item.name === "totem" && _0x3dd78c.found);
      _0x81399 && (_0x81399.found = false, console.log("Totem non ramassé, remis à disponible en (" + _0x2bde4f.x + ", " + _0x2bde4f.y + ")"));
    }
    hadTotemBeforeSearch = false;
    return;
  }
  let _0x27b96e = players[currentPlayer], _0x503fae = currentCellItems.find(_0x4f3e22 => _0x4f3e22.name === "totem");
  if (_0x503fae && hadTotemBeforeSearch) {
    showTotemScanner();
    return;
  }
  if (_0x503fae && !hadTotemBeforeSearch) {
    let _0x140c77 = hiddenItems.find(_0x40fd10 => _0x40fd10.x === _0x27b96e.x && _0x40fd10.y === _0x27b96e.y && _0x40fd10.item.name === "totem" && _0x40fd10.found);
    _0x140c77 && (_0x140c77.found = false, console.log("Totem non ramassé, remis à disponible en (" + _0x27b96e.x + ", " + _0x27b96e.y + ")"));
  }
  hadTotemBeforeSearch = false, endTurnLog(), prepareEndTurn();
}
function showTotemScanner() {
  const _0x2dd22a = getString;
  let _0x11146d = players[currentPlayer], _0x116f3f = currentCellItems.findIndex(_0x58b1a8 => _0x58b1a8.name === "totem");
  _0x116f3f !== -1 && (currentCellItems.splice(_0x116f3f, 1), respawnItem("totem"), speak("Totem activé ! Sélectionnez un objet à scanner."));
  let _0x465246 = document.getElementById("totem-items-grid");
  _0x465246.innerHTML = "", ITEMS.forEach(_0x2a9cd0 => {
    const _0x28beb9 = _0x2dd22a;
    if (_0x2a9cd0.name !== "totem") {
      let _0x4d8fbe = document.createElement("div");
      _0x4d8fbe.className = "totem-item-card", _0x4d8fbe.innerText = _0x2a9cd0.icon, _0x4d8fbe.onclick = () => selectTotemItem(_0x2a9cd0.name, _0x4d8fbe), _0x465246.appendChild(_0x4d8fbe);
    }
  }), totemSelectedItem = null, document.getElementById("totem-scan-btn").disabled = true, document.getElementById("totem-scanner-box").style.display = "block", document.getElementById("overlay").style.display = "block";
}
function selectTotemItem(_0x37977b, _0x33a87a) {
  const _0x1db62c = getString;
  document.querySelectorAll(".totem-item-card").forEach(_0x2b52ca => _0x2b52ca.classList.remove("selected")), _0x33a87a.classList.add("selected"), totemSelectedItem = _0x37977b, document.getElementById("totem-scan-btn").disabled = false;
}
function activateTotemScan() {
  ...
  let _0x49525d = ITEMS.find(_0x4a1676 => _0x4a1676.name === totemSelectedItem);
  publishGlobalEvent("totem", "a utilisé le scanner totem pour trouver " + _0x49525d.icon + " ! 🗿"), 
  speak("Scanner totem activé ! Recherche de " + totemSelectedItem + " en cours."), renderGrid();
}
function closeTotemScan() {
  const _0xadff05 = getString;
  totemScanMode = false, totemSelectedItem = null, document.getElementById("totem-ok-btn").classList.remove("visible"), endTurnLog(), prepareEndTurn();
}
function confirmTurn() {
  const _0x4a7a69 = getString;
  endTurnLog(), document.getElementById("loot-box").style.display = "none", 
  document.getElementById("overlay").style.display = "none", 
  ...
  currentPlayer === 0 && (console.log("FIN DE CYCLE - Déplacement des crocos, poissons et oiseaux"), 
  moveCrocosGlobal(),
  //moveFishesGlobal(),
  //moveBirdsGlobal(),
  updateWeather(),
  currentWeather === "Canicule" && players.forEach(_0x2cd4c2 => decreaseGourdeDurability(_0x2cd4c2)),
  currentWeather === "Orage" && players.forEach(_0x3157fb => decreaseBottesDurability(_0x3157fb))),
  startTurn();
}
function updateWeather() {
  ...
  if (currentWeather === _0x174722(685)) scenery[_0x174722(849)](_0x28588f => {
    ...
    if (_0x28588f.type === "cocotier") _0x28588f.stock++;
    ...
    if (currentWeather === _0x174722(958)) speak(_0x174722(597)); else currentWeather === "Pluie fine" ? (scenery.forEach(_0x3b1258 => {
      ...
      if (_0x3b1258.type === "bananier") _0x3b1258.stock++;
...
function showFinalRanking() {
  ...
  let _0x3cb66b = [...players].sort((_0x51c330, _0x23cad6) => _0x23cad6.votes - _0x51c330.votes), _0x339668 = "";
  _0x3cb66b.forEach((_0x2efa9e, _0x4606cb) => {
  ...
  _0x348224.querySelector("h3").innerText = "🏆 CLASSEMENT FINAL", _0x348224.querySelector("h3").style.color = "var(--gold)", _0x348224.querySelector("div").innerHTML = _0x339668, _0x348224.querySelector("p").innerHTML = "<strong style=\"color:var(--gold); font-size:1.1rem;\">🎉 VAINQUEUR : " + _0x3cb66b[0].name + "</strong><br><button onclick=\"location.reload()\" style=\"background:var(--gold); color:black; padding:12px 25px; border:none; border-radius:10px; font-size:1rem; font-weight:bold; cursor:pointer; margin-top:15px;\">REJOUER</button>";
  let _0x592462 = _0x348224.querySelector('button:not([onclick="location.reload()"])');
  if (_0x592462) _0x592462.style.display = "none";
  document.getElementById("overlay").style.display = "block", _0x348224.style.display = "block", speak("Le vainqueur est " + _0x3cb66b[0].name + " avec " + _0x3cb66b[0].votes + " votes ! Félicitations !");
}
function updateUI() {
...
function checkEvacuation(_0x21393d) {
  ...
  (_0x21393d.fatigueCards >= 5 && _0x21393d.woundCards >= 5 || _0x21393d.fatigueCards >= 8 || _0x21393d.woundCards >= 8) && evacuatePlayer(_0x21393d);
}
function evacuatePlayer(_0x25e465) {
  const _0x47a20b = getString;
  let _0x3a4e4a = document.getElementById("bite-box");
  _0x3a4e4a.querySelector("h3").innerText = "ÉVACUATION !", _0x3a4e4a.querySelector("h3").style.color = "#e74c3c", _0x3a4e4a.querySelector("div").innerText = "🚁", _0x3a4e4a.querySelector("p").innerText = "Vous êtes évacué de l'île, votre état est trop dangereux.";
  let _0x1be116 = _0x3a4e4a.querySelector("button");
  _0x1be116 && (_0x1be116.innerText = "OK", _0x1be116.style.background = "#e74c3c", _0x1be116.style.color = "white", _0x1be116.onclick = () => closeEvacuationPopup(_0x25e465)), document.getElementById("overlay").style.display = "block", _0x3a4e4a.style.display = "block", speak("Évacuation ! Vous êtes évacué de l'île."), publishGlobalEvent("evacuation", "a été évacué de l'île ! 🚁");
}
function closeEvacuationPopup(_0x41c3a1) {
  const _0x2ae395 = getString;
  document.getElementById("bite-box").style.display = "none", document.getElementById("overlay").style.display = "none";
  let _0x13ab23 = document.getElementById("bite-box"), _0x5b673c = _0x13ab23.querySelector("button");
  _0x5b673c && (_0x5b673c.innerText = "OK", _0x5b673c.style.background = "var(--red)", _0x5b673c.style.color = "white", _0x5b673c.onclick = closeBite);
  _0x13ab23.querySelector("h3").innerText = "MORSURE !", _0x13ab23.querySelector("h3").style.color = "var(--red)", _0x13ab23.querySelector("div").innerText = "🐊", _0x13ab23.querySelector("p").innerText = "Morsure : +1 Blessure.", respawnPlayerItems(_0x41c3a1);
  let _0x4dbecb = Math.floor(_0x41c3a1.votes / 2), _0x5cf922 = Math.floor(_0x4dbecb / 100) * 100;
  _0x41c3a1.fatigueCards = 0, _0x41c3a1.woundCards = 0, updateFatigueWoundDisplay(_0x41c3a1), _0x41c3a1.votes = _0x5cf922, _0x41c3a1.leftHand = null, _0x41c3a1.rightHand = null, _0x41c3a1.backpack = [null, null, null];
  _0x41c3a1.secretMission && (_0x41c3a1.secretMission = null);
  const _0x507517 = [{x: 1, y: 1}, {x: 16, y: 1}, {x: 1, y: 12}, {x: 16, y: 12}];
  _0x41c3a1.x = _0x507517[_0x41c3a1.id].x, _0x41c3a1.y = _0x507517[_0x41c3a1.id].y, _0x5cf922 > 0 ? speak("Vous redémarrez l'aventure avec " + _0x5cf922 + " votes.") : speak("Vous redémarrez l'aventure à 0."), endTurnLog(), prepareEndTurn();
}
function respawnPlayerItems(_0x4008) {
  const _0x35f894 = getString;
  let _0x1c1396 = [];
  _0x4008.leftHand && _0x4008.leftHand.name && _0x1c1396.push(_0x4008.leftHand.name), _0x4008.rightHand && _0x4008.rightHand.name && _0x1c1396.push(_0x4008.rightHand.name), _0x4008.backpack.forEach(_0x48fe94 => {
    const _0x4a18a2 = _0x35f894;
    _0x48fe94 && _0x48fe94.name && _0x1c1396.push(_0x48fe94.name);
  }), _0x1c1396.forEach(_0x4631bf => {
...
function addVotes(_0x18b24d, _0x57d835, _0x1b42eb) {
  ...
  _0x18b24d.votes += _0x57d835, turnSummary.votesGained += _0x57d835, updateUI(), speak(_0x57d835 + " votes du public ! " + _0x1b42eb), console.log(_0x18b24d.name + " gagne " + _0x57d835 + " votes : " + _0x1b42eb);
}
function hasAnyItem(_0xc780db) {
  const _0x252dce = getString;
  return _0xc780db.leftHand !== null || _0xc780db.rightHand !== null || _0xc780db.backpack.some(_0x2f8e72 => _0x2f8e72 !== null);
}
function isInventoryFull(_0x535104) {
  const _0x553be6 = getString;
  return _0x535104.leftHand !== null && _0x535104.rightHand !== null && _0x535104.backpack.every(_0x5a42ac => _0x5a42ac !== null);
}
function getAdjacentPlayersWithSpace() {
  ...
  return _0x17ad12.forEach(_0x29ed7a => {
    const _0xec761e = _0x5c072e;
    let _0x13bd9d = _0x4d622d.x + _0x29ed7a.x, _0x5b4176 = _0x4d622d.y + _0x29ed7a.y;
    players.forEach(_0x19bfa7 => {
      const _0x1deaea = _0xec761e;
      _0x19bfa7.id !== _0x4d622d.id && _0x19bfa7.x === _0x13bd9d && _0x19bfa7.y === _0x5b4176 && !isInventoryFull(_0x19bfa7) && _0x2dffd4.push(_0x19bfa7);
    });
  }), _0x2dffd4;
}
function updateGiftButton() {
  const _0x16b06c = getString;
  let _0x41d9e6 = players[currentPlayer], _0x21b6e8 = hasAnyItem(_0x41d9e6) && getAdjacentPlayersWithSpace().length > 0;
  document.getElementById("btn-gift").disabled = !_0x21b6e8;
}
function hasCanne(_0x54eef4) {
  const _0x2d6fdb = getString;
  return _0x54eef4.leftHand && _0x54eef4.leftHand.name === "canne" || _0x54eef4.rightHand && _0x54eef4.rightHand.name === "canne" || _0x54eef4.backpack.some(_0x8a669b => _0x8a669b && _0x8a669b.name === "canne");
}
function hasArc(_0x2cac69) {
  const _0x57b2c0 = getString;
  return _0x2cac69.leftHand && _0x2cac69.leftHand.name === "arc" || _0x2cac69.rightHand && _0x2cac69.rightHand.name === "arc" || _0x2cac69.backpack.some(_0x46376f => _0x46376f && _0x46376f.name === "arc");
}
function getAdjacentHuntTargets() {
  ...
  return _0x181e45.forEach(_0x4186e4 => {
    const _0x4cf934 = _0x26a73e;
    let _0x175aaa = _0x4b2b41.x + _0x4186e4.x, _0x44b097 = _0x4b2b41.y + _0x4186e4.y;
    _0x466213 && fishes.forEach(_0x557f98 => {
      const _0x43ad96 = _0x4cf934;
      _0x557f98.x === _0x175aaa && _0x557f98.y === _0x44b097 && _0x4b168e.push({type: "fish", id: _0x557f98.id, x: _0x557f98.x, y: _0x557f98.y});
    }), _0x2c3c1d && birds.forEach(_0x3e8ded => {
      const _0x43bee7 = _0x4cf934;
      _0x3e8ded.x === _0x175aaa && _0x3e8ded.y === _0x44b097 && _0x4b168e.push({type: "bird", id: _0x3e8ded.id, x: _0x3e8ded.x, y: _0x3e8ded.y});
    });
  }), _0x4b168e;
}
function updateHuntButton() {
  const _0x5db192 = getString;
  let _0xfc4b82 = players[currentPlayer], _0x1633d3 = getAdjacentHuntTargets().length > 0;
  document.getElementById("btn-hunt").disabled = !_0x1633d3;
}
function updatePublicHelpButton() {
  const _0x260bc8 = getString;
  let _0x522aa3 = players[currentPlayer], _0x980c00 = _0x522aa3.votes >= 20;
  document.getElementById("btn-public-help").disabled = !_0x980c00;
}
function huntTarget(_0x459668) {
  const _0x1b304b = getString;
  let _0x2b667d = players[currentPlayer];
  if (_0x459668.type === "fish") {
    let _0x2474b5 = fishes.findIndex(_0x16aced => _0x16aced.id === _0x459668.id);
    if (_0x2474b5 !== -1) {
      fishes.splice(_0x2474b5, 1);
      let _0x549933 = Math.min(2, _0x2b667d.fatigueCards);
      _0x2b667d.fatigueCards = Math.max(0, _0x2b667d.fatigueCards - 2), turnSummary.fatigueRemoved += _0x549933, updateFatigueWoundDisplay(_0x2b667d), checkEvacuation(_0x2b667d), _0x549933 > 0 ? speak("Vous avez pêché un poisson ! Vous vous nourrissez et retirez " + _0x549933 + " fatigue" + (_0x549933 > 1 ? "s" : "") + ".") : speak("Vous avez pêché un poisson ! Vous vous nourrissez."), respawnFish(_0x459668.id), decreaseItemDurability(_0x2b667d, "canne");
    }
  } else {
    if (_0x459668.type === "bird") {
      let _0x165ecd = birds.findIndex(_0x29708b => _0x29708b.id === _0x459668.id);
      if (_0x165ecd !== -1) {
        birds.splice(_0x165ecd, 1);
        let _0x2f38f0 = Math.min(2, _0x2b667d.fatigueCards);
        _0x2b667d.fatigueCards = Math.max(0, _0x2b667d.fatigueCards - 2), turnSummary.fatigueRemoved += _0x2f38f0, updateFatigueWoundDisplay(_0x2b667d), checkEvacuation(_0x2b667d), _0x2f38f0 > 0 ? speak("Vous avez chassé un oiseau ! Vous vous nourrissez et retirez " + _0x2f38f0 + " fatigue" + (_0x2f38f0 > 1 ? "s" : "") + ".") : speak("Vous avez chassé un oiseau ! Vous vous nourrissez."), respawnBird(_0x459668.id), decreaseItemDurability(_0x2b667d, "arc");
      }
    }
  }
  _0x2b667d.actions.push({type: "chasse", target: _0x459668.type, location: {x: _0x2b667d.x, y: _0x2b667d.y}}), checkSecretMission(_0x2b667d), huntMode = false, huntTargets = [], endTurnLog(), prepareEndTurn();
}
function respawnFish(_0x55e675) {
  ...
  for (let _0x4c824a = 0; _0x4c824a <= 17; _0x4c824a++) {
    for (let _0x274a28 = 0; _0x274a28 <= 13; _0x274a28++) {
      (_0x4c824a === 0 || _0x4c824a === 17 || _0x274a28 === 0 || _0x274a28 === 13) && _0x21595c.push({x: _0x4c824a, y: _0x274a28});
    }
  }
  let _0x1a7e9d = _0x21595c.filter(_0x408602 => {
    const _0x3ecb8b = _0x173197;
    if (crocos.some(_0x5f0ece => _0x5f0ece.x === _0x408602.x && _0x5f0ece.y === _0x408602.y)) return false;
    ...
    let _0x40f55a = fishes.some(_0x59af39 => {
      let _0x6745da = getDistance(_0x59af39.x, _0x59af39.y, _0x408602.x, _0x408602.y);
      return _0x6745da < 4;
    });
    return !_0x40f55a;
  });
  if (_0x1a7e9d.length > 0) {
    let _0x5064bd = _0x1a7e9d[Math.floor(Math.random() * _0x1a7e9d.length)];
    fishes.push({id: _0x55e675, x: _0x5064bd.x, y: _0x5064bd.y}), console.log("Poisson " + _0x55e675 + " réapparu en (" + _0x5064bd.x + ", " + _0x5064bd.y + ")");
  }
}
function respawnBird(_0x37e087) {
  ...
  let _0x33adff = _0x493207.filter(_0x35f4e8 => {
    ...
    if (fishes.some(_0x1135e8 => _0x1135e8.x === _0x35f4e8.x && _0x1135e8.y === _0x35f4e8.y)) return false;
    if (birds.some(_0xcff82c => _0xcff82c.x === _0x35f4e8.x && _0xcff82c.y === _0x35f4e8.y)) return false;
    return true;
  });
  if (_0x33adff.length > 0) {
    let _0x2411ae = _0x33adff[Math.floor(Math.random() * _0x33adff.length)];
    birds.push({id: _0x37e087, x: _0x2411ae.x, y: _0x2411ae.y}), console.log("Oiseau " + _0x37e087 + " réapparu en (" + _0x2411ae.x + ", " + _0x2411ae.y + ")");
  }
}
...
function showGiftInventory() {
  ...
  selectedItem = null, currentCellItems = [], document.getElementById("inv-left").innerText = _0xb948cb.leftHand ? _0xb948cb.leftHand.icon : "", document.getElementById("inv-right").innerText = _0xb948cb.rightHand ? _0xb948cb.rightHand.icon : "", document.getElementById("inv-back0").innerText = _0xb948cb.backpack[0] ? _0xb948cb.backpack[0].icon : "", document.getElementById("inv-back1").innerText = _0xb948cb.backpack[1] ? _0xb948cb.backpack[1].icon : "", document.getElementById("inv-back2").innerText = _0xb948cb.backpack[2] ? _0xb948cb.backpack[2].icon : "", document.getElementById("loot-box").querySelector("h3").innerText = "DONNER UN OBJET", document.getElementById("items-found").innerHTML = "<p style=\"color: #999;\">Cliquez sur l'objet à donner</p>";
  let _0x499b5c = document.getElementById("loot-box").querySelector("button");
  _0x499b5c.innerText = "ANNULER", _0x499b5c.onclick = cancelGift, document.getElementById("inv-left").onclick = () => giveItemFromSlot("left"), document.getElementById("inv-right").onclick = () => giveItemFromSlot("right"), document.getElementById("inv-back0").onclick = () => giveItemFromSlot("back0"), document.getElementById("inv-back1").onclick = () => giveItemFromSlot("back1"), document.getElementById("inv-back2").onclick = () => giveItemFromSlot("back2"), document.getElementById("loot-box").style.display = "block", document.getElementById("overlay").style.display = "block";
}
function giveItemFromSlot(_0x13bc0b) {
  ...
  if (_0x13bc0b === "left") {
    _0x2ecb28 = _0x17e961.leftHand;
    if (!_0x2ecb28) return;
    _0x17e961.leftHand = null;
  } else {
    if (_0x13bc0b === "right") {
      _0x2ecb28 = _0x17e961.rightHand;
      if (!_0x2ecb28) return;
      _0x17e961.rightHand = null;
    } else {
      if (_0x13bc0b.startsWith("back")) {
        let _0x5d14fb = parseInt(_0x13bc0b.replace("back", ""));
        _0x2ecb28 = _0x17e961.backpack[_0x5d14fb];
        if (!_0x2ecb28) return;
        _0x17e961.backpack[_0x5d14fb] = null;
      }
    }
  }
  let _0x53b726 = false;
  for (let _0xb7d636 = 0; _0xb7d636 < 3; _0xb7d636++) {
    if (_0x42b71d.backpack[_0xb7d636] === null) {
      _0x42b71d.backpack[_0xb7d636] = _0x2ecb28, _0x53b726 = true;
      break;
    }
  }
  !_0x53b726 && _0x42b71d.leftHand === null && (_0x42b71d.leftHand = _0x2ecb28, _0x53b726 = true), !_0x53b726 && _0x42b71d.rightHand === null && (_0x42b71d.rightHand = _0x2ecb28, _0x53b726 = true), turnSummary.itemsUsed.push({icon: _0x2ecb28.icon, name: _0x2ecb28.name || _0x2ecb28.type, action: "donné"}), _0x17e961.actions.push({type: "don", item: _0x2ecb28, to: giftTargetPlayer, location: {x: _0x17e961.x, y: _0x17e961.y}}), checkSecretMission(_0x17e961), speak("Objet donné au joueur " + _0x42b71d.name + " !"), closeGiftInventory();
}
function cancelGift() {
...
function closeGiftInventory() {
  ...
  let _0x31bbc8 = document.getElementById("loot-box").querySelector("button");
  _0x31bbc8.innerText = "TERMINER", _0x31bbc8.onclick = closeLoot, document.getElementById("inv-left").onclick = () => selectInventorySlot("left"), document.getElementById("inv-right").onclick = () => selectInventorySlot("right"), document.getElementById("inv-back0").onclick = () => selectInventorySlot("back0"), document.getElementById("inv-back1").onclick = () => selectInventorySlot("back1"), document.getElementById("inv-back2").onclick = () => selectInventorySlot("back2"), document.getElementById("loot-box").style.display = "none", document.getElementById("overlay").style.display = "none", giftMode = false, giftTargetPlayer = null, endTurnLog(), prepareEndTurn();
}
function showRestMenu() {
  const _0x3c5de9 = getString;
  let _0x5b5fdd = players[currentPlayer], _0x4ef29a = document.getElementById("consumable-items");
  _0x4ef29a.innerHTML = "";
  let _0x59758a = [];
  _0x5b5fdd.leftHand && isConsumable(_0x5b5fdd.leftHand) && _0x59758a.push({item: _0x5b5fdd.leftHand, slot: "left"}), _0x5b5fdd.rightHand && isConsumable(_0x5b5fdd.rightHand) && _0x59758a.push({item: _0x5b5fdd.rightHand, slot: "right"}), _0x5b5fdd.backpack.forEach((_0x4dbd1f, _0x7027c9) => {
    const _0x1f76ac = _0x3c5de9;
    _0x4dbd1f && isConsumable(_0x4dbd1f) && _0x59758a.push({item: _0x4dbd1f, slot: "back" + _0x7027c9});
  }), _0x59758a.length === 0 ? _0x4ef29a.innerHTML = "<p style=\"color: #999; font-size: 0.85rem; margin: 10px 0;\">Aucun objet consommable</p>" : _0x59758a.forEach(_0x361905 => {
    const _0x157854 = _0x3c5de9;
    let _0x3906d2 = document.createElement("button");
    _0x3906d2.style.cssText = "background:#27ae60; color:white; width:100%; padding:10px; border:none; border-radius:8px; font-weight:bold; cursor:pointer; font-size:0.85rem; display:flex; align-items:center; gap:8px;";
    let _0x11c149 = getConsumableEffect(_0x361905.item);
    _0x3906d2.innerHTML = '<span style="font-size:1.5rem;">' + _0x361905.item.icon + '</span><span style="flex:1; text-align:left;">' + _0x11c149.name + "</span>", _0x3906d2.onclick = () => consumeItem(_0x361905.slot, _0x11c149), _0x4ef29a.appendChild(_0x3906d2);
  }), document.getElementById("rest-box").style.display = "block", document.getElementById("overlay").style.display = "block";
}
function isConsumable(_0xd2c8fe) {
  const _0x203afd = getString;
  return _0xd2c8fe.name === "trousse" || _0xd2c8fe.type === "fruit";
}
function getConsumableEffect(_0x3220ea) {
  const _0x40ec6d = getString;
  if (_0x3220ea.name === "trousse") return {name: "Trousse de soin", message: "Vous vous soignez. Retirez 2 blessures et 1 fatigue.", fatigue: -1, wound: -2}; else {
    if (_0x3220ea.icon === "🥥") return {name: "Noix de coco", message: "Vous récupérez fatigue et immunité. -1 Fatigue et -1 Blessure.", fatigue: -1, wound: -1}; else {
      if (_0x3220ea.icon === "🍌") return {name: "Banane", message: "Un petit coup de boost. Défaussez 2 fatigues.", fatigue: -2, wound: 0}; else {
        if (_0x3220ea.icon === "🥭") return {name: "Mangue", message: "Un petit coup de boost. -2 Fatigues.", fatigue: -2, wound: 0};
      }
    }
  }
  return null;
...
function doRest() {
  ...
  if (_0x3805a6) {
    let _0x5d5a98 = _0x597075.fatigueCards, _0x13258c = _0x597075.woundCards;
    _0x597075.fatigueCards = 0, _0x597075.woundCards = 0, turnSummary.fatigueRemoved += _0x5d5a98, turnSummary.woundRemoved += _0x13258c, updateFatigueWoundDisplay(_0x597075), checkEvacuation(_0x597075);
    let _0x2bc53e = "Repos au camp ! Toutes les fatigues (" + _0x5d5a98 + ") et blessures (" + _0x13258c + ") sont retirées !";
    speak(_0x2bc53e), publishGlobalEvent("rest", "s'est reposé au camp et a récupéré toutes ses forces ! 🏕️"), (_0x5d5a98 > 0 || _0x13258c > 0) && addVotes(_0x597075, 30, "Repos complet au camp !");
  } else _0x597075.fatigueCards > 0 ? (_0x597075.fatigueCards--, turnSummary.fatigueRemoved++, updateFatigueWoundDisplay(_0x597075), checkEvacuation(_0x597075), speak("Vous vous reposez. -1 Fatigue.")) : speak("Vous vous reposez mais vous n'avez pas de fatigue.");
  _0x597075.actions.push({type: "repos", location: {x: _0x597075.x, y: _0x597075.y}, inCamp: _0x3805a6}), checkSecretMission(_0x597075), closeRest(), endTurnLog(), prepareEndTurn();
}
function consumeItem(_0x4627e1, _0x446a69) {
  const _0xdd5e02 = getString;
  let _0x1b6a77 = players[currentPlayer];
  if (_0x4627e1 === "left") _0x1b6a77.leftHand = null; else {
    if (_0x4627e1 === "right") _0x1b6a77.rightHand = null; else {
      if (_0x4627e1.startsWith("back")) {
        let _0x2c311b = parseInt(_0x4627e1.replace("back", ""));
        _0x1b6a77.backpack[_0x2c311b] = null;
      }
    }
  }
  if (_0x446a69.fatigue < 0) {
    let _0x3ae00e = Math.min(-_0x446a69.fatigue, _0x1b6a77.fatigueCards);
    _0x1b6a77.fatigueCards = Math.max(0, _0x1b6a77.fatigueCards + _0x446a69.fatigue), turnSummary.fatigueRemoved += _0x3ae00e;
  }
  if (_0x446a69.wound < 0) {
    let _0x3ca469 = Math.min(-_0x446a69.wound, _0x1b6a77.woundCards);
    _0x1b6a77.woundCards = Math.max(0, _0x1b6a77.woundCards + _0x446a69.wound), turnSummary.woundRemoved += _0x3ca469;
  }
  updateFatigueWoundDisplay(_0x1b6a77), checkEvacuation(_0x1b6a77), turnSummary.itemsUsed.push({icon: _0x446a69.name.includes("Noix") ? "🥥" : _0x446a69.name.includes("Banane") ? "🍌" : _0x446a69.name.includes("Mangue") ? "🥭" : "🩹", name: _0x446a69.name, action: "consommé"}), speak(_0x446a69.message);
  if (_0x446a69.name === "Noix de coco") respawnFruit("cocotier", "🥥"); else {
    if (_0x446a69.name === "Banane") respawnFruit("bananier", "🍌"); else _0x446a69.name === "Mangue" && respawnMangue();
  }
  _0x1b6a77.actions.push({type: "soin", item: _0x446a69.name, location: {x: _0x1b6a77.x, y: _0x1b6a77.y}}), closeRest(), endTurnLog(), prepareEndTurn();
}
function closeRest() {
  const _0x4e2834 = getString;
  document.getElementById("rest-box").style.display = "none", document.getElementById("overlay").style.display = "none";
}
function closeBite() {
  const _0x1fda8b = getString;
  // Popup removed - using toast notifications, document.getElementById("bite-box").querySelector("h3").innerText = "MORSURE !", document.getElementById("bite-box").querySelector("h3").style.color = "var(--red)", document.getElementById("bite-box").querySelector("div").innerText = "🐊", document.getElementById("bite-box").querySelector("p").innerText = "Morsure : +1 Blessure";
}
function decreaseHandItemsDurability(_0x105348) {
  const _0x59c42d = getString;
  _0x105348.leftHand && _0x105348.leftHand.durability !== null && ((_0x105348.leftHand.name === "torche" || _0x105348.leftHand.name === "pioche") && (_0x105348.leftHand.durability--, _0x105348.leftHand.durability <= 0 && (speak("Votre " + _0x105348.leftHand.name + " est cassée !"), turnSummary.itemsBroken.push({icon: _0x105348.leftHand.icon, name: _0x105348.leftHand.name}), respawnItem(_0x105348.leftHand.name), _0x105348.leftHand = null))), _0x105348.rightHand && _0x105348.rightHand.durability !== null && ((_0x105348.rightHand.name === "torche" || _0x105348.rightHand.name === "pioche") && (_0x105348.rightHand.durability--, _0x105348.rightHand.durability <= 0 && (speak("Votre " + _0x105348.rightHand.name + " est cassée !"), turnSummary.itemsBroken.push({icon: _0x105348.rightHand.icon, name: _0x105348.rightHand.name}), respawnItem(_0x105348.rightHand.name), _0x105348.rightHand = null)));
}
function decreaseBottesDurability(_0x2ff5db) {
  const _0x1baeea = getString;
  _0x2ff5db.leftHand && _0x2ff5db.leftHand.name === "bottes" && _0x2ff5db.leftHand.durability !== null && (_0x2ff5db.leftHand.durability--, _0x2ff5db.leftHand.durability <= 0 && (speak("Les bottes de " + _0x2ff5db.name + " sont usées !"), turnSummary.itemsBroken.push({icon: _0x2ff5db.leftHand.icon, name: "bottes"}), respawnItem("bottes"), _0x2ff5db.leftHand = null)), _0x2ff5db.rightHand && _0x2ff5db.rightHand.name === "bottes" && _0x2ff5db.rightHand.durability !== null && (_0x2ff5db.rightHand.durability--, _0x2ff5db.rightHand.durability <= 0 && (speak("Les bottes de " + _0x2ff5db.name + " sont usées !"), turnSummary.itemsBroken.push({icon: _0x2ff5db.rightHand.icon, name: "bottes"}), respawnItem("bottes"), _0x2ff5db.rightHand = null)), _0x2ff5db.backpack.forEach((_0x4ecc4a, _0x359e8a) => {
    const _0x1a9bbb = _0x1baeea;
    _0x4ecc4a && _0x4ecc4a.name === "bottes" && _0x4ecc4a.durability !== null && (_0x4ecc4a.durability--, _0x4ecc4a.durability <= 0 && (speak("Les bottes de " + _0x2ff5db.name + " sont usées !"), turnSummary.itemsBroken.push({icon: _0x4ecc4a.icon, name: "bottes"}), respawnItem("bottes"), _0x2ff5db.backpack[_0x359e8a] = null));
  });
}
function decreaseGourdeDurability(_0x24e9e4) {
  const _0x51067f = getString;
  _0x24e9e4.leftHand && _0x24e9e4.leftHand.name === "gourde" && _0x24e9e4.leftHand.durability !== null && (_0x24e9e4.leftHand.durability--, _0x24e9e4.leftHand.durability <= 0 && (speak("La gourde de " + _0x24e9e4.name + " est vide !"), respawnItem("gourde"), _0x24e9e4.leftHand = null)), _0x24e9e4.rightHand && _0x24e9e4.rightHand.name === "gourde" && _0x24e9e4.rightHand.durability !== null && (_0x24e9e4.rightHand.durability--, _0x24e9e4.rightHand.durability <= 0 && (speak("La gourde de " + _0x24e9e4.name + " est vide !"), respawnItem("gourde"), _0x24e9e4.rightHand = null)), _0x24e9e4.backpack.forEach((_0x360a44, _0x2a638c) => {
    const _0x470da5 = _0x51067f;
    _0x360a44 && _0x360a44.name === "gourde" && _0x360a44.durability !== null && (_0x360a44.durability--, _0x360a44.durability <= 0 && (speak("La gourde de " + _0x24e9e4.name + " est vide !"), respawnItem("gourde"), _0x24e9e4.backpack[_0x2a638c] = null));
  });
}
function decreaseItemDurability(_0x21db62, _0xda5dc7) {
  const _0x5a4b4b = getString;
  if (_0x21db62.leftHand && _0x21db62.leftHand.name === _0xda5dc7 && _0x21db62.leftHand.durability !== null) {
    _0x21db62.leftHand.durability--;
    _0x21db62.leftHand.durability <= 0 && (speak("Votre " + _0xda5dc7 + " est cassée !"), turnSummary.itemsBroken.push({icon: _0x21db62.leftHand.icon, name: _0xda5dc7}), respawnItem(_0xda5dc7), _0x21db62.leftHand = null);
    return;
  }
  if (_0x21db62.rightHand && _0x21db62.rightHand.name === _0xda5dc7 && _0x21db62.rightHand.durability !== null) {
    _0x21db62.rightHand.durability--;
    _0x21db62.rightHand.durability <= 0 && (speak("Votre " + _0xda5dc7 + " est cassée !"), turnSummary.itemsBroken.push({icon: _0x21db62.rightHand.icon, name: _0xda5dc7}), respawnItem(_0xda5dc7), _0x21db62.rightHand = null);
    return;
  }
  for (let _0x9df252 = 0; _0x9df252 < _0x21db62.backpack.length; _0x9df252++) {
    let _0x1f536b = _0x21db62.backpack[_0x9df252];
    if (_0x1f536b && _0x1f536b.name === _0xda5dc7 && _0x1f536b.durability !== null) {
      _0x1f536b.durability--;
      _0x1f536b.durability <= 0 && (speak("Votre " + _0xda5dc7 + " est cassée !"), turnSummary.itemsBroken.push({icon: _0x1f536b.icon, name: _0xda5dc7}), respawnItem(_0xda5dc7), _0x21db62.backpack[_0x9df252] = null);
      return;
    }
  }
}
function openQRScanner() {
  ...
  document.getElementById("qr-scanner-modal").style.display = "block", document.getElementById("qr-status").innerText = "Positionnez le QR Code devant la caméra", html5QrCode = new Html5Qrcode("qr-reader");
  const _0x9f9be0 = {fps: 10, qrbox: {width: 250, height: 250}, aspectRatio: 1};
  html5QrCode.start({facingMode: "environment"}, _0x9f9be0, onQRCodeScanned, onQRCodeError).then(() => {
    isScanning = true;
  }).catch(_0x4afd04 => {
    const _0x57ec9f = _0x16cbe3;
    console.error("Erreur démarrage caméra:", _0x4afd04), document.getElementById("qr-status").innerText = "Erreur: Impossible d'accéder à la caméra";
  });
}
...
function onQRCodeScanned(_0x146f5e, _0x1685f9) {
  ...
  console.log("QR Code scanné:", _0x146f5e);
...
function checkSecretMission(_0x39625e) {
  ...
  if (!_0x39625e.secretMission || _0x39625e.secretMission.completed) return;
  _0x39625e.secretMission.condition(_0x39625e) && (_0x39625e.secretMission.completed = true, !_0x39625e.completedMissions && (_0x39625e.completedMissions = []), _0x39625e.completedMissions.push({id: _0x39625e.secretMission.id, description: _0x39625e.secretMission.description, votes: _0x39625e.secretMission.votes}), turnSummary.missionsCompleted.push({id: _0x39625e.secretMission.id, description: _0x39625e.secretMission.description, votes: _0x39625e.secretMission.votes}), addVotes(_0x39625e, _0x39625e.secretMission.votes, "Mission secrète accomplie : " + _0x39625e.secretMission.description), console.log(_0x39625e.name + " a accompli sa mission secrète !"), publishGlobalEvent("mission", "a accompli sa mission secrète #" + _0x39625e.secretMission.id + " ! (+" + _0x39625e.secretMission.votes + " votes) ⭐"), _0x39625e.secretMission = null, updateUI());
}
function checkFruitsCollected(_0x312d4a, _0x15bb26) {
  const _0x43c8e4 = getString;
  let _0x59f2d5 = [];
  _0x312d4a.leftHand && _0x312d4a.leftHand.type === "fruit" && _0x59f2d5.push(_0x312d4a.leftHand.icon);
  _0x312d4a.rightHand && _0x312d4a.rightHand.type === "fruit" && _0x59f2d5.push(_0x312d4a.rightHand.icon);
  _0x312d4a.backpack.forEach(_0x326d58 => {
    const _0x49a70a = _0x43c8e4;
    _0x326d58 && _0x326d58.type === "fruit" && _0x59f2d5.push(_0x326d58.icon);
  });
...
function checkMove3WithoutBite3Times(_0x3e7de9) {
  ...
  let _0x13e683 = _0x3e7de9.actions.filter(_0x22f340 => _0x22f340.type === "move");
  if (_0x13e683.length < 3) return false;
  let _0x283420 = _0x13e683.slice(-3);
  for (let _0x56d83f = 0; _0x56d83f < _0x283420.length; _0x56d83f++) {
    let _0x56fea2 = _0x283420[_0x56d83f];
    if (_0x56fea2.distance !== 3) return false;
    if (_0x56fea2.bites && _0x56fea2.bites > 0) return false;
  }
  return true;
}
function checkGiftGiven(_0x1a06e9) {
  const _0x209c63 = getString;
  return _0x1a06e9.actions.some(_0x27c181 => _0x27c181.type === "don");
}
function checkHunt2Animals(_0x37b380) {
  const _0x2ceb7d = getString;
  return _0x37b380.actions.filter(_0x1d96fd => _0x1d96fd.type === "chasse").length >= 2;
}
function checkTotemFound(_0x55ca0f) {
  const _0x123e7a = getString;
  let _0xfb0a40 = _0x55ca0f.actions.filter(_0x3d737d => _0x3d737d.type === "fouille" || _0x3d737d.type === "fouille_auto").flatMap(_0x911812 => _0x911812.items);
  return _0xfb0a40.some(_0x1045dc => _0x1045dc.name === "totem");
}
function checkSurvive3Bites(_0x439149) {
  ...
  return _0x439149.turnStartBites >= 3;
}
function checkTwoTorches(_0xca8fc3) {
  const _0x1f3068 = getString;
  return _0xca8fc3.leftHand && _0xca8fc3.leftHand.name === "torche" && _0xca8fc3.rightHand && _0xca8fc3.rightHand.name === "torche";
}
...
function checkCollect5Items(_0x26dd32) {
  ...
  let _0x3fd504 = [];
  _0x26dd32.leftHand && _0x26dd32.leftHand.name && _0x3fd504.push(_0x26dd32.leftHand.name);
  _0x26dd32.rightHand && _0x26dd32.rightHand.name && _0x3fd504.push(_0x26dd32.rightHand.name);
  _0x26dd32.backpack.forEach(_0x32c6ee => {
    const _0x4c9f4a = _0x5ba1b1;
    _0x32c6ee && _0x32c6ee.name && _0x3fd504.push(_0x32c6ee.name);
  });
  let _0x3c7eb4 = new Set(_0x3fd504);
  return _0x3c7eb4.size >= 5;
}
...
function recordActionClick(_0x22d73f) {
  ...
  _0x3b87af.lastActionClicks.push({actionType: _0x22d73f, turnNumber: _0x3b87af.actions.filter(_0x3de25d => _0x3de25d.type === "move").length + 1}), _0x3b87af.lastActionClicks.length > 3 && _0x3b87af.lastActionClicks.shift(), console.log("Clics enregistrés pour " + _0x3b87af.name + ":", _0x3b87af.lastActionClicks);
}
function check3ConsecutiveHideClicks() {
  const _0x49c118 = getString;
  let _0x518589 = players[currentPlayer];
  if (_0x518589.lastActionClicks.length < 3) return false;
  let _0x2b152b = _0x518589.lastActionClicks.slice(-3);
  return _0x2b152b.every(_0x1206e => _0x1206e.actionType === "cache");
}
function respawnFruit(_0x2c30c9, _0x1357e8) {
  const _0xa6404 = getString;
  let _0x356220 = scenery.filter(_0x11070e => _0x11070e.type === _0x2c30c9);
  if (_0x356220.length === 0) return;
  let _0x401610 = _0x356220[Math.floor(Math.random() * _0x356220.length)];
  _0x401610.stock++, console.log(_0x1357e8 + " régénéré sur " + _0x2c30c9 + " en (" + _0x401610.x + ", " + _0x401610.y + ")");
}
function respawnMangue() {
  const _0x3572d5 = getString;
  let _0x231600 = mangues.filter(_0x137359 => _0x137359.found);
  if (_0x231600.length === 0) return;
  let _0x1dd6e0 = _0x231600[Math.floor(Math.random() * _0x231600.length)];
  _0x1dd6e0.found = false, console.log("🥭 Mangue régénérée en (" + _0x1dd6e0.x + ", " + _0x1dd6e0.y + ")");
}
...
function handleDiamondFound(_0x23a6ce) {
  ...
  let _0x469d76 = turnSummary.itemsCollected.some(_0x2379e2 => _0x2379e2.icon === "💎" && _0x2379e2.name === "diamant");
  !_0x469d76 && turnSummary.itemsCollected.push({icon: "💎", name: "diamant"});
  addVotes(_0x23a6ce, 200, "Découverte d'un diamant !");
  let _0x906901 = document.getElementById("bite-box");
  _0x906901.querySelector("h3").innerText = "FÉLICITATIONS !", _0x906901.querySelector("h3").style.color = "var(--gold)", _0x906901.querySelector("div").innerText = "💎", _0x906901.querySelector("p").innerText = "Vous avez trouvé un diamant ! Vous gagnez 200 votes !";
  let _0x23eae3 = _0x906901.querySelector("button");
  _0x23eae3 && (_0x23eae3.innerText = "CONTINUER", _0x23eae3.style.background = "var(--gold)", _0x23eae3.style.color = "black", _0x23eae3.onclick = closeDiamondPopup), document.getElementById("overlay").style.display = "block", _0x906901.style.display = "block", speak("Félicitations ! Vous avez trouvé un diamant ! 200 votes du public !"), publishGlobalEvent("diamond", "a trouvé un diamant ! 💎 (+200 votes)");
}
...
function respawnItem(_0x1f6990) {
  ...
  if (_0x4fb9f1.length === 0) return;
  let _0x118613 = _0x4fb9f1[Math.floor(Math.random() * _0x4fb9f1.length)];
  const _0x2bde8c = [{x1: 1, x2: 8, y1: 1, y2: 6}, {x1: 9, x2: 16, y1: 1, y2: 6}, {x1: 1, x2: 8, y1: 7, y2: 12}, {x1: 9, x2: 16, y1: 7, y2: 12}];
  let _0x2167bc = _0x2bde8c[_0x118613.zone], _0x1e4539 = false, _0x791053 = 0;
  while (!_0x1e4539 && _0x791053 < 100) {
    let _0x78d7da = Math.floor(Math.random() * (_0x2167bc.x2 - _0x2167bc.x1 + 1)) + _0x2167bc.x1, _0x20f275 = Math.floor(Math.random() * (_0x2167bc.y2 - _0x2167bc.y1 + 1)) + _0x2167bc.y1;
    if (getBaseOwner(_0x78d7da, _0x20f275) === null && !(_0x78d7da === 0 || _0x78d7da === 17 || _0x20f275 === 0 || _0x20f275 === 13) && !(_0x78d7da >= 7 && _0x78d7da <= 10 && _0x20f275 >= 5 && _0x20f275 <= 8)) {
      _0x118613.x = _0x78d7da, _0x118613.y = _0x20f275, _0x118613.found = false, _0x118613.discovered = false;
      let _0x13badb = ITEMS.find(_0xcc0f25 => _0xcc0f25.name === _0x1f6990);
      _0x13badb && (_0x118613.item = createItem(_0x13badb)), _0x1e4539 = true, console.log(_0x118613.item.icon + " " + _0x1f6990 + " régénéré dans zone " + _0x118613.zone + " en (" + _0x78d7da + ", " + _0x20f275 + ")");
    }
    _0x791053++;
  }
  if (!_0x1e4539) {
    _0x118613.found = false, _0x118613.discovered = false;
    let _0x29d1ec = ITEMS.find(_0x27c46e => _0x27c46e.name === _0x1f6990);
    _0x29d1ec && (_0x118613.item = createItem(_0x29d1ec)), console.log(_0x118613.item.icon + " " + _0x1f6990 + " régénéré à l'ancienne position (" + _0x118613.x + ", " + _0x118613.y + ")");
  }
}
...
function endGame() {
  ...
  stopGlobalTimer();
  showFinalRanking();
  speak('Temps écoulé ! Fin de la partie !');
}
